...
**Wall-clock:** ~5 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0323)
...
b0290..b0324 (thirty-fifth consecutive tick).
...
Page sha256 this tick: `98ff20677bc9645ba5afe474fccad83ce89a0d0068aeb55c6e45e4f3ff51824e`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0323) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0323) |
...
See `_work/batch_0324_probe.json`.

## Cost / budget

- Today (UTC) fetches before tick: 56 (b0310..b0323 ran earlier on 2026-04-28)
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 60 / 2000 (~3.0%)
...
Phase 4 appears at upstream steady state for the **thirty-fifth**
consecutive tick (b0290..b0324). Worker does **not** flip

...
**Wall-clock:** ~5 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0317)
...
b0290..b0318 (twenty-ninth consecutive tick).
...
A stray empty `.git/index.lock` appeared mid-tick and was rotated to
`_stale_locks/index.lock.b0318` before commit.
...
Page sha256 this tick: `6b2922449d3af0886983bf63f3b42244617f280c0c4569d2d5320afee57f6c69`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0317) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0317) |
...
See `_work/integrity_b0318.json`.

## Cost / budget

- Today (UTC) fetches before tick: 32 (b0310..b0317 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **twenty-ninth**
consecutive tick (b0290..b0318). Worker does **not** flip

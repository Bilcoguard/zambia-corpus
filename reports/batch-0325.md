...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0324)
...
b0290..b0325 (thirty-sixth consecutive tick).
...
Page sha256 this tick: `5eef5a6c5f8083b996b4f6a9f1d345567b6d34845b92651111523062bc8fca93`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0324) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0324) |
...
See `_work/batch_0325_probe.json`.

## Cost / budget

- Today (UTC) fetches before tick: 60 (b0310..b0324 ran earlier on 2026-04-28)
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 64 / 2000 (~3.2%)
...
Phase 4 appears at upstream steady state for the **thirty-sixth**
consecutive tick (b0290..b0325). Worker does **not** flip

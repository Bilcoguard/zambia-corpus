...
**Wall-clock:** ~1 min (probe + commit)
**Parser version:** 0.5.0 (probe-only — same as b0290..b0329)
...
b0290..b0330 (forty-first consecutive tick).

This is the first tick of the 2026-04-29 (UTC) day; daily fetch budget
resets to 0 at UTC midnight per `costs.log` accounting.
...
Page bytes: 95,392 (unchanged vs b0329).
Page sha256: `507f7542eddc74c7089f669398fc86861aea75d60dc9dabe0fbddb922d79321c`
(UNCHANGED vs b0329 — feed surface and ranking are byte-for-byte
identical to b0329).

Note: 2025/5 and 2025/28, 2025/29 do not appear in the recent feed
surface this tick, but all are present in `records/acts/` (sourced via
parliament's chronological feed and prior alphabet sweeps).
...
Page bytes: 38,208 (unchanged across all 41 steady-state ticks).
Page sha256 this tick: `2ebf59d409ff2825f160eefd8329e222f695245afe2eacd934c8e325ec228024`
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0329) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0329) |
...
| 5 known dual-location pairs unchanged | PASS (long-standing pre-tick state, not a regression) |

See `_work/batch_0330_probe.json`.

## Cost / budget

- Today (UTC) fetches before tick: 0 (first tick of 2026-04-29 UTC; daily counter reset)
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 4 / 2000 (~0.2%)
...
Phase 4 appears at upstream steady state for the **forty-first**
consecutive tick (b0290..b0330). Worker does **not** flip

...
**Wall-clock:** ~5 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0320)
...
b0290..b0321 (thirty-second consecutive tick).
...
Page sha256 this tick: `96df5e0e4ec2873121d458223a9179033cda964777c2e1cc14144aeff1917982`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0320) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0320) |
...
See `_work/integrity_b0321.json`.

## Cost / budget

- Today (UTC) fetches before tick: 44 (b0310..b0320 ran earlier on 2026-04-28)
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 48 / 2000 (~2.4%)
...
Phase 4 appears at upstream steady state for the **thirty-second**
consecutive tick (b0290..b0321). Worker does **not** flip

...
**Wall-clock:** ~5 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0322)
...
b0290..b0323 (thirty-fourth consecutive tick).
...
and does not block git ops — rotated to `_stale_locks/` pre-commit).
...
Page sha256 this tick: `e5efaa5d2f9ae0cab1be2133a867811e133e05a45d377a192cef82e0342fbc21`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0322) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0322) |
...
See `_work/integrity_b0323.json`.

## Cost / budget

- Today (UTC) fetches before tick: 52 (b0310..b0322 ran earlier on 2026-04-28)
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 56 / 2000 (~2.8%)
...
Phase 4 appears at upstream steady state for the **thirty-fourth**
consecutive tick (b0290..b0323). Worker does **not** flip

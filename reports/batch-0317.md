...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0316)
...
b0290..b0317 (twenty-eighth consecutive tick).
...
Page sha256 this tick: `942a12034c9429e54b0a873234ba5cfac6a5835619e421d739a7a5db92d49670`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0316) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0316) |
...
See `_work/integrity_b0317.json`.

## Cost / budget

- Today (UTC) fetches before tick: 28 (b0310..b0316 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **twenty-eighth**
consecutive tick (b0290..b0317). Worker does **not** flip

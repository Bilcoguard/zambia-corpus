...
**Parser version:** 0.5.0 (probe-only — same as b0290..b0328)
...
b0290..b0329 (fortieth consecutive tick).
...
Page bytes: 95,392 (was 95,192 in b0327/b0328 — small bytes delta).
Page sha256: `507f7542eddc74c7089f669398fc86861aea75d60dc9dabe0fbddb922d79321c`
(changed vs b0328 — feed re-ranked again; act-pair set is the same
2025/2026 surface modulo ranking; no novel pairs).
...
Page bytes: 38,208 (unchanged across all 40 steady-state ticks).
Page sha256 this tick: `31a9497734bf3fc19543e79fb2553aab9f710cbefb4e85add72b09ccd431acf6`
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0328) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0328) |
...
See `_work/batch_0329_probe.json`.

## Cost / budget

- Today (UTC) fetches before tick: 76 (b0310..b0328 ran earlier on 2026-04-28)
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 80 / 2000 (~4.0%)
...
Phase 4 appears at upstream steady state for the **fortieth**
consecutive tick (b0290..b0329). Worker does **not** flip

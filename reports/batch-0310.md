...
**Wall-clock:** ~2 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0309)
...
b0290..b0310 (twenty-one consecutive ticks).
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0309) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0309) |
...
See `_work/integrity_b0310.json`.

## Cost / budget

- Today (UTC) fetches before tick: 0 (new UTC day)
...
Phase 4 appears at upstream steady state for the **twenty-first**
consecutive tick (b0290..b0310). Worker does **not** flip

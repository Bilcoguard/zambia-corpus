...
**Wall-clock:** ~2 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0308)
...
b0290..b0309 (twenty consecutive ticks).
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0308) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0308) |
...
See `_work/integrity_b0309.json`.

## Cost / budget

- Today (UTC) fetches before tick: 124
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 128 / 2000 (~6.4%)
...
Phase 4 appears at upstream steady state for the **twentieth**
consecutive tick (b0290..b0309). Worker does **not** flip

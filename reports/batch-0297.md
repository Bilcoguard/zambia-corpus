...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0296)
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0296) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0296) |
...
After b0290..b0297, **every priority_order sub-phase is exhaustively
...
`_work/batch_0297_integrity.py` — **PASS**:
...
- Today (2026-04-27 UTC) fetches at tick start: 76 (per costs.log)
- Today (2026-04-27 UTC) fetches at tick end:   80/2,000 (~4.0%)
  - This tick: 4 fetches.
...
- `scripts/batch_0297.py` (PICKS=[] documentation skeleton)
- `_work/batch_0297_*` (discover, recent HTML, parliament HTML,
  robots caches, integrity script, probe.json)
- `reports/batch-0297.md` (this file)

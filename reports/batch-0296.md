...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0295)
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0295) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0295) |
...
After b0290..b0296, **every priority_order sub-phase is exhaustively
...
Until one of the above is actioned, future ticks (b0297+) will continue
to idle on phase_4_bulk with re-run probes that only re-confirm steady
state.

## Integrity

`_work/batch_0296_integrity.py` — **PASS**:
...
- Today (2026-04-27 UTC) fetches at tick start: 72 (per costs.log)
- Today (2026-04-27 UTC) fetches at tick end:   76/2,000 (~3.8%)
  - This tick: 4 fetches.
...
- `scripts/batch_0296.py` (PICKS=[] documentation skeleton)
- `_work/batch_0296_*` (discover, recent HTML, parliament HTML,
  robots caches, integrity script, probe.json)
- `reports/batch-0296.md` (this file)

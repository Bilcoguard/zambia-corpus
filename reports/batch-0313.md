...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0312)
...
b0290..b0313 (twenty-fourth consecutive tick).
...
Page sha256 this tick: `a4bc105be8ec43744bd79930eb3202ffc9bb7be1338af193fca6f445694b1f32`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0312) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0312) |
...
See `_work/integrity_b0313.json`.

## Cost / budget

- Today (UTC) fetches before tick: 12 (b0310 + b0311 + b0312 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **twenty-fourth**
consecutive tick (b0290..b0313). Worker does **not** flip

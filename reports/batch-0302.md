...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0301)
...
b0290..b0302 (thirteen consecutive ticks).
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0301) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0301) |
...
- acts cumulative count: 1169 (unchanged from b0301)
- SIs cumulative count: 539 (unchanged from b0301)
- judgments cumulative count: 25 (unchanged from b0301)
...
21 records (unchanged from b0293..b0301). Awaiting host-side OCR flow.

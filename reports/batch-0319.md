...
**Wall-clock:** ~5 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0318)
...
b0290..b0319 (thirtieth consecutive tick).
...
Page sha256 this tick: `4dbcbb0e2c834b419e3040ee2d41dab982d4c4729cb37201fff31a0eb30d4443`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0318) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0318) |
...
See `_work/integrity_b0319.json`.

## Cost / budget

- Today (UTC) fetches before tick: 36 (b0310..b0318 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **thirtieth**
consecutive tick (b0290..b0319). Worker does **not** flip

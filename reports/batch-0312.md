...
**Wall-clock:** ~2 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0311)
...
b0290..b0312 (twenty-three consecutive ticks).
...
Page sha256 this tick: `5db8d2d9ff0e4ba1141af23c64acb4b8dd736b19d69a23def115026fdf0e5e27`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0311) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0311) |
...
See `_work/integrity_b0312.json`.

## Cost / budget

- Today (UTC) fetches before tick: 8 (b0310 + b0311 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **twenty-third**
consecutive tick (b0290..b0312). Worker does **not** flip

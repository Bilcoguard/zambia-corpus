...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0314)
...
b0290..b0315 (twenty-sixth consecutive tick).
...
Page sha256 this tick: `260fafea015ad704046af5bb71fb89fa04743eae3d7bacc84062e90cc146ca6b`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0314) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0314) |
...
See `_work/integrity_b0315.json`.

## Cost / budget

- Today (UTC) fetches before tick: 20 (b0310..b0314 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **twenty-sixth**
consecutive tick (b0290..b0315). Worker does **not** flip

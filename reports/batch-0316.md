...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0315)
...
b0290..b0316 (twenty-seventh consecutive tick).
...
Page sha256 this tick: `ef92c8fac7c94d7965a7c83b31b0be6efadab19adf5e35ab40e4a16cf1a1f3a3`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0315) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0315) |
...
See `_work/integrity_b0316.json`.

## Cost / budget

- Today (UTC) fetches before tick: 24 (b0310..b0315 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **twenty-seventh**
consecutive tick (b0290..b0316). Worker does **not** flip

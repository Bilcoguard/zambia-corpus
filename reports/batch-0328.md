...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0327)
...
b0290..b0328 (thirty-ninth consecutive tick).
...
(unchanged vs b0327 — feed surface has not re-ranked since b0327).
...
Page sha256 this tick: `256eefeafd8a58a7d6f19b11928bbe524fd41ede91e09fa3bade1f1c3af430fd`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0327) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0327) |
...
See `_work/batch_0328_probe.json`.

## Cost / budget

- Today (UTC) fetches before tick: 72 (b0310..b0327 ran earlier on 2026-04-28)
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 76 / 2000 (~3.8%)
...
Phase 4 appears at upstream steady state for the **thirty-ninth**
consecutive tick (b0290..b0328). Worker does **not** flip

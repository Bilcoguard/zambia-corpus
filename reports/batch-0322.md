...
**Wall-clock:** ~5 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0321)
...
b0290..b0322 (thirty-third consecutive tick).
...
Page sha256 this tick: `f0537e2169dc1eb6ea5c8fe59b6611d52e027204dae544384bb05d8aa61d9569`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0321) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0321) |
...
See `_work/integrity_b0322.json`.

## Cost / budget

- Today (UTC) fetches before tick: 48 (b0310..b0321 ran earlier on 2026-04-28)
- Fetches this tick: 4 (2 robots + 2 page probes)
- Today (UTC) fetches after tick: 52 / 2000 (~2.6%)
...
Phase 4 appears at upstream steady state for the **thirty-third**
consecutive tick (b0290..b0322). Worker does **not** flip

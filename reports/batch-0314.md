...
**Wall-clock:** ~3 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0313)
...
b0290..b0314 (twenty-fifth consecutive tick).
...
Page sha256 this tick: `67e891262982aa8f83a9763cf46db889014df6b878240b7877af80f2c7a761fb`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0313) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0313) |
...
See `_work/integrity_b0314.json`.

## Cost / budget

- Today (UTC) fetches before tick: 16 (b0310..b0313 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **twenty-fifth**
consecutive tick (b0290..b0314). Worker does **not** flip

...
**Wall-clock:** ~5 min
**Parser version:** 0.5.0 (probe-only — same as b0290..b0319)
...
b0290..b0320 (thirty-first consecutive tick).
...
Page sha256 this tick: `0b121dd9283472c165f71ed9da5a21c3dcbd4e34ba2d2a7d9aef8b961b4f5ab5`.
...
| Source     | sha256 | Match |
|------------|--------|-------|
| zambialii  | `fce67b697ee4ef44e0694134e23108c2701b5e7661eed885013efb9b75dcd8f0` | yes (unchanged from b0193..b0319) |
| parliament | `278e83bcf567badfebcdea4d5d20ca9898e4449fe4eb2e3b5a08227b4ca9b762` | yes (unchanged from b0290..b0319) |
...
See `_work/integrity_b0320.json`.

## Cost / budget

- Today (UTC) fetches before tick: 40 (b0310..b0319 ran earlier on 2026-04-28)
...
Phase 4 appears at upstream steady state for the **thirty-first**
consecutive tick (b0290..b0320). Worker does **not** flip

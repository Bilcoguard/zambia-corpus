"""Batch 0298 integrity check (probe-only refresh tick).
...
def main():
    ...
    # Load probe data
    probe = json.loads((ROOT / "_work" / "batch_0298_probe.json").read_text())
    ...
    print("\nbatch 0298 integrity: PASS (probe-only; CHECK1..CHECK6 N/A — zero record writes)")

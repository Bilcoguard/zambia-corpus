"""Batch 0311 integrity / steady-state invariant assertions.
...
probe = json.loads(Path("_work/batch_0311_probe.json").read_text())
...
Path("_work/integrity_b0311.json").write_text(json.dumps({

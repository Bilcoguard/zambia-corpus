"""Batch 0243 discovery 3 - paginated year listings (year=2024 page=2/3, year=2023 page=2/3)
to surface novel modern SIs beyond the first page.
"""
...
candidates = []
# Year 2024 deeper pagination
for page in [2,3]:
    nv = probe_url(f"https://zambialii.org/legislation/?year=2024&page={page}", f"year=2024p{page}", f"year2024p{page}")
    candidates += [(f"y2024p{page}", n) for n in nv]
    if len(candidates) >= 8:
        break

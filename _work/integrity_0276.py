#!/usr/bin/env python3
"""Integrity check for batch 0276 (8 records).
...
PICKS = [
    ("1920","2","public-pounds-and-trespass-act"),
    ("1925","24","export-of-pigs-act"),
    ("1929","20","public-officers-change-of-titles-act"),
    ("1944","13","extermination-of-mosquitoes-act"),
    ("1953","59","noxious-weeds-act"),
    ("1964","14","public-holidays-act"),
    ("1964","56","public-seal-act"),
    ("1968","40","notaries-public-and-notarial-functions-act"),
]

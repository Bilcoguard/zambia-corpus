"""Batch 0297 integrity check (probe-only refresh tick).
...
def main():
    ...
    # Load probe data
    probe = json.loads((ROOT / "_work" / "batch_0297_probe.json").read_text())
    ...
    print("\nbatch 0297 integrity: PASS (probe-only; CHECK1..CHECK6 N/A — zero record writes)")

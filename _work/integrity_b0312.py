"""Batch 0312 integrity / steady-state invariant assertions.
...
probe = json.loads(Path("_work/batch_0312_probe.json").read_text())
...
Path("_work/integrity_b0312.json").write_text(json.dumps({

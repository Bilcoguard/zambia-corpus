"""Batch 0313 integrity / steady-state invariant assertions.
...
probe = json.loads(Path("_work/batch_0313_probe.json").read_text())
...
Path("_work/integrity_b0313.json").write_text(json.dumps({

"""Ingest a single PICK index from batch_0227 — per-record subprocess pattern.

Pattern proven in batches 0225/0226. 35-40s shell timeout per call,
4.5MB PDF size guard for scanned-image PDFs.
"""
...
from batch_0227 import PICKS, slugify, fetch, CRAWL, PARSER_VERSION, UA, HEADERS
...
if __name__ == '__main__':
    ...
    out = f'_work/batch_0227_one_{idx}.json'

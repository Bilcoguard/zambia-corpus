"""Ingest a single PICK index from batch_0238 — per-record subprocess pattern.

Mirror of batch_0237 ingest_one. Invoke via:
    python3 _work/batch_0238_ingest_one.py <idx> [sleep_first=1]

Writes _work/batch_0238_one_<idx>.json with status=ok|skip|fail.
"""
...
from batch_0238 import PICKS, slugify, fetch, CRAWL, PARSER_VERSION, UA, HEADERS
...
if __name__ == '__main__':
    ...
    out = f'_work/batch_0238_one_{idx}.json'

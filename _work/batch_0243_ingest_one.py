"""Ingest a single PICK index from batch_0243 - per-record subprocess pattern.
Mirror of batch_0241. Invoke via:
    python3 _work/batch_0243_ingest_one.py <idx> [sleep_first=1]
Writes _work/batch_0243_one_<idx>.json with status=ok|skip|fail.
"""
...
from batch_0243 import PICKS, slugify, fetch, CRAWL, PARSER_VERSION, UA, HEADERS
...
if __name__ == '__main__':
    ...
    out = f'_work/batch_0243_one_{idx}.json'

"""Ingest a single PICK index from batch_0239 — per-record subprocess pattern.

Mirror of batch_0238 ingest_one. Invoke via:
    python3 _work/batch_0239_ingest_one.py <idx> [sleep_first=1]

Writes _work/batch_0239_one_<idx>.json with status=ok|skip|fail.
"""
...
from batch_0239 import PICKS, slugify, fetch, CRAWL, PARSER_VERSION, UA, HEADERS
...
if __name__ == '__main__':
    ...
    out = f'_work/batch_0239_one_{idx}.json'

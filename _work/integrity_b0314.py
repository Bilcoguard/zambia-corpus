"""Batch 0314 integrity / steady-state invariant assertions.
...
probe = json.loads(Path("_work/batch_0314_probe.json").read_text())
...
Path("_work/integrity_b0314.json").write_text(json.dumps({

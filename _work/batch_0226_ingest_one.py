"""Ingest a single PICK index from batch_0226 — robust per-record subprocess pattern.

Pattern proven in batch 0225: 35-40s shell timeout per call, 4.5MB PDF size guard
to avoid pdfplumber multi-minute hang on scanned-image PDFs.
"""
...
from batch_0226 import PICKS, slugify, fetch, CRAWL, PARSER_VERSION, UA, HEADERS
...
if __name__ == '__main__':
    ...
    out = f'_work/batch_0226_one_{idx}.json'

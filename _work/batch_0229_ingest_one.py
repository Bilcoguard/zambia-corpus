"""Ingest a single PICK index from batch_0229 — per-record subprocess pattern.

Mirror of batch_0228 ingest_one. 35-40s shell timeout per call,
...
from batch_0229 import PICKS, slugify, fetch, CRAWL, PARSER_VERSION, UA, HEADERS
...
if __name__ == '__main__':
    ...
    out = f'_work/batch_0229_one_{idx}.json'

#!/usr/bin/env python3
"""Batch 0520 — judgment-ingestion-worker dedicated tick.

Wraps b0506 fetcher; reads targets from _work/b0520/targets.json by default.
Continues ZMSC 2023 most-recent-first sweep into nums {17..10}
(per b0519 next-tick recommendation).
"""
import json
import pathlib
import sys

"""Batch 0314 — Phase 4 / minimal upstream-refresh tick (25th consecutive steady-state tick).

Inherited closing state (after b0290..b0313):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0313).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0313)
...
PROBE RESULTS (see _work/batch_0314_probe.json for full data):
...
SANDBOX NOTE (carried from b0299..b0313):
...
Phase 4 disposition unchanged from b0293..b0313: cannot meaningfully

#!/usr/bin/env python3
"""Repair worker batch 034 — fixes up to 8 corrupted/empty Act/SI bodies.

Follows SKILL.md repair worker spec (v4, 2026-05-12 tick).
Continuation of b033 (2010 PTT + 2011 series). b034 drains the next 8 manifest
records in declaration order: VAT 2011 + 2012 series (003/006/007/008/010/011/012).
"""
...
WORKDIR  = "/sessions/gifted-brave-ride/mnt/corpus"
PDF_DIR  = os.path.join(WORKDIR, "_repair_b034_pdfs")
TMPROOT  = os.path.join(WORKDIR, "_repair_b034_tmpdb")
...
# Continues from b033. b034 targets next 8 in manifest order.
MANIFEST = [
    ...
    ("act-zm-2012-006-the-persons-with-disabilities-act-2012", "https://www.parliament.gov.zm/sites/default/files/documents/acts/The%20Persons%20with%20disabilities%20act%2C%202012.PDF"),
    ("act-zm-2012-007-the-civil-aviation-authority-act-2012", "https://www.parliament.gov.zm/sites/default/files/documents/acts/The%20Civil%20aviation%20Authority%20Act%2C%202012.PDF"),
    ("act-zm-2012-008-the-re-denomination-of-currency-act-2012", "https://www.parliament.gov.zm/sites/default/files/documents/acts/Redomination%20of%20Currency.PDF"),
    ("act-zm-2012-010-the-income-tax-amendment-act-2012", "https://www.parliament.gov.zm/sites/default/files/documents/amendment_act/Income%20tax%20act%2C%202012.PDF"),
    ("act-zm-2012-011-the-medical-levy-repeal-act-2012", "https://www.parliament.gov.zm/sites/default/files/documents/acts/Medical%20Levy%20%28Repeal%29.PDF"),
    ("act-zm-2012-012-mines-and-minerals-development-amendment-act-2012", "https://www.parliament.gov.zm/sites/default/files/documents/amendment_act/Mines%20and%20Minerals%20Development%20Act%20%28Amendment%29%2C%202012.PDF"),
]

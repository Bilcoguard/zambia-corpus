#!/usr/bin/env python3
"""Batch 0525 — judgment-ingestion-worker dedicated tick.

Wraps b0506 fetcher; reads targets from _work/b0525/targets.json by default.
Continues ZMSC 2022 most-recent-first sweep into nums {45..38}
(per b0523 next-tick recommendation).

Note: b0524 was used by the main corpus worker (Phase 8 nightly reverify);
this judgment-ingestion-worker tick advances to b0525.
"""
import json
import pathlib
import sys

#!/usr/bin/env python3
"""Batch 0521 — judgment-ingestion-worker dedicated tick.

Wraps b0506 fetcher; reads targets from _work/b0521/targets.json by default.
Continues ZMSC 2023 most-recent-first sweep into nums {9..2}
(per b0520 next-tick recommendation).
"""
import json
import pathlib
import sys

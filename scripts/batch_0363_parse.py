#!/usr/bin/env python3
"""Batch 0363 parser-only step (REPARSE-FIRST PASS, continuation of b0362).
...
b0362's 2025/{22..14} slice with the next eight raw-on-disk
candidates:
  zmcc 2025/12, 2025/11, 2025/10, 2025/09, 2025/08, 2025/07,
  2025/06, 2025/05.
...
TARGETS = [
    ...
    # before locking the slice — see worker.log for b0363).
    # Batch 0363 (REPARSE PASS): continuation of b0362 deferred queue,
    ...
    ("zmcc", 2025, 11, "2025-06-19"),
    ("zmcc", 2025, 10, "2025-06-04"),
    ("zmcc", 2025,  9, "2025-02-10"),
    ("zmcc", 2025,  8, "2025-04-01"),
    ("zmcc", 2025,  7, "2025-04-07"),
    ("zmcc", 2025,  6, "2025-03-24"),
    ("zmcc", 2025,  5, "2025-03-24"),
]

"""Batch 0339 — Phase 4 / minimal upstream-refresh tick (50th consecutive steady-state tick).

Inherited closing state (after b0290..b0338):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0338).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0338)
...
PROBE RESULTS (see _work/batch_0339_probe.json for full data):
  ...
  /legislation/recent:    15 act links (2026/1..11 + 2025/6..9).
                          ...
                          (UNCHANGED for the eleventh consecutive tick —
                          feed surface and ranking are byte-for-byte
                          identical to b0329..b0338).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged across all 50
                          steady-state ticks).
                          page sha256: b693c061ae8527fd4be9edca83311bcd211f54d21987d386895fcb8ce7c8a4c4
...
SANDBOX NOTE (carried from b0299..b0338):
  ...
  - This tick the sandbox session changed to dreamy-keen-heisenberg;
    ROOT was rewritten accordingly and the probe was split into three
    stages (stage_a: zambialii fetches; stage_b: parliament fetches;
...
# The probe lives at _work/batch_0339_stage_{a,b,c}.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0338: cannot meaningfully

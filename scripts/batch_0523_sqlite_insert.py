#!/usr/bin/env python3
"""Batch 0523 — insert this tick's 4 ZMSC 2022 records into corpus.sqlite.
...
def main():
    """Use TMPDIR-routed atomic copy pattern (b0519/b0520/b0521 precedent)
    to avoid FUSE journal cleanup errors when writing to in-place
    ...
    with tempfile.TemporaryDirectory(prefix="b0523_sqlite_") as tmp:

"""Batch 0337 — Phase 4 / minimal upstream-refresh tick (48th consecutive steady-state tick).

Inherited closing state (after b0290..b0336):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0336).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0336)
...
PROBE RESULTS (see _work/batch_0337_probe.json for full data):

  /legislation/recent:    15 act links (2026/1..11 + 2025/6..9).
                          ALL 15 in corpus (steady state).
                          page bytes: 95,392 (unchanged vs b0329..b0336).
                          page sha256: 507f7542eddc74c7089f669398fc86861aea75d60dc9dabe0fbddb922d79321c
                          (UNCHANGED for the ninth consecutive tick —
                          feed surface and ranking are byte-for-byte
                          identical to b0329..b0336).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged across all 48
                          steady-state ticks).
                          page sha256: 041c72a833be3289b02c1a9a9e9e34bbbc36a16343362df8f69ed76efbad0654
...
SANDBOX NOTE (carried from b0299..b0336):
...
# The probe lives at _work/batch_0337_probe.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0336: cannot meaningfully

#!/usr/bin/env python3
"""Audit-only tick batch-0451 (Phase 5 judgments).
...
Outputs:
  _work/b0451/audit_summary.json    — machine-readable result
  reports/batch-0451.md             — human report (written separately)
...
Checks:
  ...
  5. 6 random spot-recompute (deterministic seed=451)
...
def main():
    ...
    # 5. Spot-recompute (deterministic seed=451) ---------------------------

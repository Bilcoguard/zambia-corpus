#!/usr/bin/env python3
"""
Batch 0188 — Phase 4 case_law_scz rotation.

Rotates from sis_employment (exhausted via pre-2003 corridor in batch 0186)
to case_law_scz (priority_order item 5) per the batch 0186 next-tick plan.

Discovery: ZambiaLII /judgments/ZMSC/ index page 1 (already fetched into
raw/zambialii/judgments/zmsc/zmsc-index-page-1-20260424.html at the start
of this tick) surfaces 50 links of the form
  /akn/zm/judgment/zmsc/{year}/{num}/eng@{date}
with textual citation in the form "[YYYY] ZMSC NN".

Targets (4 × 2 fetches = 8 AKN HTML + PDF) — recent 2026 judgments, skipping
2026/8 which duplicates the batch-3 pilot (Konkola Copper Mines v AG,
recorded in HEAD as judgment-zm-2026-scz-09-konkola-v-ag under the appeal
number docket rather than the ZMSC neutral citation):

  - zmsc/2026/10  First Quantum Mining v Zubao Harry Juma (17 April 2026)
  - zmsc/2026/7   Munir Zulu v Attorney General and Chibwili (13 March 2026)
  - zmsc/2026/4   Ventriglia and Anor v Finance Bank Zambia Ltd (10 March 2026)
  - zmsc/2026/1   Kapsch Trafficom SA Holding v Intelligent Mobility Solutions
                  (29 January 2026)
...
each record takes ~12-15s. 4 records therefore sliced into 2 + 2 via
--slice=START:END with a _work/batch_0187_summary.json resume checkpoint.
"""
import argparse
import hashlib
import io

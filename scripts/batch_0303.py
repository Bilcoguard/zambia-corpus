"""Batch 0303 — Phase 4 / minimal upstream-refresh tick (14th consecutive steady-state tick).

Inherited closing state (after b0290..b0302):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0302).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0302)
...
PROBE RESULTS (see _work/batch_0303_probe.json for full data):
...
SANDBOX NOTE (carried from b0299..b0302):
...
Phase 4 disposition unchanged from b0293..b0302: cannot meaningfully

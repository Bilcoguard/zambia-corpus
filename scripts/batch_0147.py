#!/usr/bin/env python3
"""
Batch 0147 — Phase 4 bulk ingestion.

Continuation of the batch 0146 next-tick plan: Bank of Zambia 2001
(deferred), Mines and Minerals 2011 (deferred), and fresh principal-
statute candidates across regulatory / local-government / insurance /
wildlife / immigration / tourism domains obtained via ZambiaLII search
API probes.

Candidate (year, num) pairs were obtained from the `results_html`
fragment of the search API
(`/search/api/documents/?search=<q>&nature=Act`) for queries including
'Bank of Zambia 2001', 'Mines and Minerals', 'Fisheries', 'Insurance',
'Pensions and Insurance', 'Public Finance', 'Local Government',
'National Parks', 'Immigration', 'Tourism', 'Consumer Protection',
'Copyright and Performance', 'Trade Marks', 'Patents'. Each hit was
cross-referenced against HEAD by (year, num) tuple via
`git ls-tree -r HEAD records/acts/`. Probes logged to costs.log /
provenance.log under batch tag "0147-probe".
...
# (year, act_number, slug_hint_for_diagnostics). Deferred targets from
# batch 0146 come first (Bank of Zambia 2001 parent, Mines and Minerals
# 2011 variant). Then fresh primary-statute candidates from regulatory /
# local-government / insurance / wildlife / immigration / tourism
# search probes. All pairs cross-referenced against HEAD via
# /tmp/head_year_num.txt to ensure no (year, num) collisions.
TARGETS = [
    (2001, 11, "bank-of-zambia-2001"),                      # deferred from 0146
    (2011, 28, "mines-minerals-2011"),                      # deferred from 0146
    (1974, 21, "fisheries-1974"),
    (2005, 26, "pensions-and-insurance-2005"),
    (1993, 30, "local-government-1993"),
    (2004, 15, "public-finance-2004"),
    (1965, 29, "immigration-and-deportation-1965"),
    (1998, 12, "zambia-wildlife-1998"),
    (1994, 22, "consumer-protection-1994"),
    (1991, 21, "local-government-1991"),
    (1997, 25, "immigration-1997"),
    (2007, 23, "tourism-2007"),
]
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed):
    ...
    lines = [
        ...
        "## Strategy",
        "",
        "Continuation of the batch 0146 next-tick plan: Bank of Zambia "
        "2001 (2001/11, deferred from 0146), Mines and Minerals 2011 "
        "(2011/28, deferred from 0146), plus fresh primary-statute "
        "candidates from regulatory / local-government / insurance / "
        "wildlife / immigration / tourism search probes. "
        "Candidate (year, num) pairs were obtained by parsing the "
        "`results_html` fragment of the ZambiaLII search API "
        "(`/search/api/documents/?search=<q>&nature=Act`) across 16 "
        "hint queries (Trade Marks, Patents, Insurance, Pensions and "
        "Insurance, Public Finance, Local Government, National Parks, "
        "Immigration, Tourism, Consumer Protection, Copyright and "
        "Performance, Competition, Bank of Zambia 2001, Mines and "
        "Minerals, Fisheries, Probate and Administration of Estates); "
        "each hit was cross-referenced against HEAD by (year, num) "
        "tuple via `git ls-tree -r HEAD records/acts/`. Twelve "
        "non-HEAD candidates were queued; the processor fetches each "
        "AKN page, applies a title-token filter (rejects `amendment`, "
    ...
    lines.extend([
        ...
        "- Next tick: continue the primary-statute sweep — pending "
        "candidates include Trade Marks Act (Cap 401 / 1958 parent), "
        "Patents Act (Cap 400 / 1957 parent), Town and Country Planning "
        "Act parents (1961/32, 1974/30), Valuation Surveyors Act "
        "(1976/34), Local Government Elections Act (2004/9), Judges "
        "(Emoluments) variants (1976/22, 1988/21), National Parks and "
        "Wildlife Act 1971/27 / 1982/33, Zambia Tourism Board / Zambia "
        "National Tourism Board parents (1979/29, 1985/22), Chartered "
        "Institute of Public Relations (2003/15), and the unresolved "
        "Citizens Economic Empowerment Act 2006 correct AKN slot. "
        "Also pending: repeal-chain links "
        "act-zm-1996-042-anti-corruption-commission-act-1996 → "
        "act-zm-2012-003 and act-zm-1965-056-prisons → "

#!/usr/bin/env python3
"""Batch 0354 parser-only step.

Parses the 8 ZMCC 2023 raw HTML+PDF pairs persisted by
batch_0354_fetch.py under the tightened parser_version 0.3.0 policy

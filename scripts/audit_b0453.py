#!/usr/bin/env python3
"""Audit-only tick batch-0453 (Phase 5 judgments).
...
Outputs:
  _work/b0453/audit_summary.json    — machine-readable result
  reports/batch-0453.md             — human report (written separately)
...
Checks:
  ...
  5. 6 random spot-recompute (deterministic seed=453)
...
def main():
    ...
    # 5. Spot-recompute (deterministic seed=453) ---------------------------

#!/usr/bin/env python3
"""Integrity check for batch-0494 (Phase 5 ZMCC ingestion).

Validates the records written by batch_0494_parse.py (driven from
_work/b0494/parse_summary.json):
...
SUMMARY = ROOT / "_work/b0494/parse_summary.json"

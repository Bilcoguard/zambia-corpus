...
Continues ingestion of the 5 residual sis_employment candidates preserved
in _work/batch_0185_candidates.json after the 0185 tick wrote its first 8
candidates. All 5 residuals are pre-2003 NAPSA / pension / workmen's
compensation SIs with employment-law substance (priority_order item 4).
...
3 + 2 via --slice=START:END with a _work/batch_0186_state.json
resume checkpoint — same pattern as 0182/0183.

Targets (5 × 2 fetches = 10 AKN HTML + PDF):
  - si/2002/39  Pension Scheme (Offshore Investments) Regulations, 2002
  - si/2000/37  Pension Scheme Regulation (Investment) (Exemption) Order, 2000
  - si/2000/34  National Pension Scheme (Transfer of Employees) Order, 2000
  - si/2000/22  National Pension Scheme (Pensionable Earnings) Regulations, 2000
  - si/1994/39  Workmen's Compensation (Assessment of Earnings) Regulations, 1994
"""
import argparse
import hashlib
import io
...
TARGETS = [
    (2021, 21),   # Cyber Security and Cyber Crimes Act (Commencement) Order, 2021
    (2021, 22),   # Data Protection Act (Commencement) Order, 2021
    (2021, 23),   # Electronic Communications and Transactions (Commencement) Order, 2021
    (2016, 31),   # Postal and Courier Services (General) Regulations, 2015
    (2003, 22),   # Postal Services (Courier Service) (Licence) Regulations, 2003
]

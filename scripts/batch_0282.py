#!/usr/bin/env python3
"""Batch 0282 - Phase 4 bulk ingest. acts_in_force chronological-first.

Per next-tick plan in batch 0281 worker.log entry:
- Refreshed pool inherited from _work/batch_0281_remaining.json (62 items).
- Sweep next 8 chronologically-earliest from refreshed pool avoiding gaps.md-listed items.
- Robots.txt re-verified at start of tick (sha256 fce67b697ee4ef44... unchanged).

First 8 chronological from inherited pool:
  2009/7  Supplementary Appropriation (2007) Act, 2009            (alpha S, fiscal)
  2009/10 Appropriation Act, 2009                                 (alpha A, fiscal)
  2009/16 Non-Governmental Organisations Act, 2009                (alpha N, NON-FISCAL)
  2009/30 Appropriation (No. 2) Act, 2009                         (alpha A, fiscal)
  2010/4  Public Interest Disclosure (Protection of Whistleblowers) Act, 2010 (alpha P, NON-FISCAL)
  2010/11 Supplementary Appropriation (2008) Act, 2010            (alpha S, fiscal)
  2010/23 Excess Expenditure Appropriation (2007) Act, 2010       (alpha E, fiscal)
  2011/25 Supplementary Appropriation (2009) Act, 2011            (alpha S, fiscal)

NOTE: 2 non-fiscal acts (2009/16 NGO Act, 2010/4 Whistleblowers Act). Yield should
improve over baseline because non-fiscal acts have proper akn-section structure in
HTML and rarely require PDF fallback.
...
Reuses parser from batches 0269..0281 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"2009","num":"7","title":"Supplementary Appropriation (2007) Act, 2009",
     "slug":"supplementary-appropriation-2007-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"2009","num":"10","title":"Appropriation Act, 2009",
     "slug":"appropriation-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"2009","num":"16","title":"Non-Governmental Organisations Act, 2009",
     "slug":"non-governmental-organisations-act","sub_phase":"acts_in_force","alpha":"N"},
    {"yr":"2009","num":"30","title":"Appropriation (No. 2) Act, 2009",
     "slug":"appropriation-no-2-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"2010","num":"4","title":"Public Interest Disclosure (Protection of Whistleblowers) Act, 2010",
     "slug":"public-interest-disclosure-protection-of-whistleblowers-act","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"2010","num":"11","title":"Supplementary Appropriation (2008) Act, 2010",
     "slug":"supplementary-appropriation-2008-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"2010","num":"23","title":"Excess Expenditure Appropriation (2007) Act, 2010",
     "slug":"excess-expenditure-appropriation-2007-act","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"2011","num":"25","title":"Supplementary Appropriation (2009) Act, 2011",
     "slug":"supplementary-appropriation-2009-act","sub_phase":"acts_in_force","alpha":"S"},
]

#!/usr/bin/env python3
"""Integrity check b0529 — judgment-ingestion-worker tick.

Validates the 1 ZMSC 2022 record written this tick (num 29) passes the
...
def main():
    ...
    print(f"Integrity check b0529: {passed} passed / {failed} failed")
    if errors:
        for e in errors:
            print(f"  FAIL: {e}")
        sys.exit(1)

...
TARGETS = [
    ...
    # before locking the slice — see worker.log for b0366).
    # Batch 0367 (REPARSE PASS): continuation of b0366 deferred queue,
    ...
    # raw HTML before locking the slice (worker.log b0367).
    ("zmcc", 2023, 13, "2023-09-28"),
    ("zmcc", 2023, 12, "2023-09-26"),
    ("zmcc", 2023, 10, "2023-09-19"),
    ("zmcc", 2023,  8, "2023-01-31"),
    ("zmcc", 2023,  6, "2023-07-31"),
    ("zmcc", 2023,  5, "2023-06-15"),
    ("zmcc", 2023,  4, "2023-03-30"),
    ("zmcc", 2023,  3, "2023-03-10"),
]

"""Batch 0306 — Phase 4 / minimal upstream-refresh tick (17th consecutive steady-state tick).

Inherited closing state (after b0290..b0305):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0305).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0305)
...
PROBE RESULTS (see _work/batch_0306_probe.json for full data):
...
SANDBOX NOTE (carried from b0299..b0305):
...
Phase 4 disposition unchanged from b0293..b0305: cannot meaningfully

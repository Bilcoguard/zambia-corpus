"""Batch 0326 — Phase 4 / minimal upstream-refresh tick (37th consecutive steady-state tick).

Inherited closing state (after b0290..b0325):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0325).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0325)
...
PROBE RESULTS (see _work/batch_0326_probe.json for full data):
  ...
  parliament page 0:      20 act links (2025/21..29 + 2026/1..11)
                          ALL 20 in corpus.
                          page sha256: ffe4cc04a68a9afb... (differs
                          from b0325 — session/CSRF token churn;
...
SANDBOX NOTE (carried from b0299..b0325):
...
# The probe lives at _work/batch_0326_probe.py (gitignored).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0325: cannot meaningfully

"""Batch 0309 — Phase 4 / minimal upstream-refresh tick (20th consecutive steady-state tick).

Inherited closing state (after b0290..b0308):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0308).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0308)
...
PROBE RESULTS (see _work/batch_0309_probe.json for full data):
...
SANDBOX NOTE (carried from b0299..b0308):
...
Phase 4 disposition unchanged from b0293..b0308: cannot meaningfully

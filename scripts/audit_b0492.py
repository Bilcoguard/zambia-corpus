#!/usr/bin/env python3
"""Audit-only tick batch-0492 (Phase 5 judgments).

Re-runs the same audit/integrity sweep as the prior consecutive
audit-only ticks (b0375..b0383, b0385..b0464). No fresh fetches.

Outputs:
  _work/b0492/audit_summary.json    — machine-readable result
  reports/batch-0492.md             — human report (written separately)
...
Checks:
  ...
  5. 6 random spot-recompute (deterministic seed=492)
...
def main():
    ...
    # 5. Spot-recompute (deterministic seed=492) ---------------------------

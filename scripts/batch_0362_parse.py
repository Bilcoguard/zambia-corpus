#!/usr/bin/env python3
"""Batch 0362 parser-only step (REPARSE-FIRST PASS, continuation of b0361).
...
picking candidates whose record was never written. Skips the slice
b0361 already attempted (2026/1, 2025/{33,32,30,28,25,24,23}):
  zmcc 2025/22, 2025/21, 2025/19, 2025/18, 2025/17, 2025/16,
  2025/15, 2025/14.
...
TARGETS = [
    ...
    # before locking the slice — see worker.log for b0362).
    # Batch 0362 (REPARSE PASS): continuation of b0361 deferred queue,

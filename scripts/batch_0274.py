#!/usr/bin/env python3
"""Batch 0274 - Phase 4 bulk ingest. acts_in_force chronological-first across all alphabets.

Per next-tick plan in batch 0273 worker.log entry, sweep next 8 of 12 alphabet=A
Appropriation Act residuals (1987-1995 chronological). Titles verified against cached
raw/zambialii/legislation/alphabet-A-20260425.html (exact-match in <a> text and
"Act <num> of <yr>" citation cell). Pre-flight on-disk check: all 8 confirmed not on
records/acts/<yr>/act-zm-<yr>-<num>-*.json (avoided silent overwrite per BRIEF #4).

Picks total = 8 (MAX_BATCH_SIZE). 4 alphabet-A residuals carry to next tick
(Appropriation Acts 1996/13, 1997/13, 1998/3, 1999/3). Other reserved residuals: 1956/4
disambiguator-deferred; 2 alphabet-C deferred (1996/17 Constitution + 2006/9 CEE);
OCR backlog 17 items (2000/8 + 2000/16 + 15 prior).

Reuses parser from batch_0269..0273 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"1987","num":"15","title":"Appropriation Act, 1987",
     "slug":"appropriation-act-1987","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1988","num":"19","title":"Appropriation Act, 1988",
     "slug":"appropriation-act-1988","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1989","num":"34","title":"Appropriation Act, 1989",
     "slug":"appropriation-act-1989","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1990","num":"44","title":"Appropriation Act, 1990",
     "slug":"appropriation-act-1990","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1992","num":"17","title":"Appropriation Act, 1992",
     "slug":"appropriation-act-1992","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1993","num":"22","title":"Appropriation Act, 1993",
     "slug":"appropriation-act-1993","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1994","num":"5","title":"Appropriation Act, 1994",
     "slug":"appropriation-act-1994","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1995","num":"1","title":"Appropriation Act, 1995",
     "slug":"appropriation-act-1995","sub_phase":"acts_in_force","alpha":"A"},
]

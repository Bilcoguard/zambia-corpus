"""Batch 0295 — Phase 4 / minimal upstream-refresh tick.

Inherited closing state (after b0290..b0294):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0294).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0294)
...
PROBE RESULTS (see _work/batch_0295_probe.json for full data):
...
Phase 4 disposition unchanged from b0293..b0294: cannot meaningfully

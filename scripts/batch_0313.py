...
Inherited closing state (after b0290..b0312):
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0312)
...
PROBE RESULTS (see _work/batch_0313_probe.json for full data):

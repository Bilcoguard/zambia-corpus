#!/usr/bin/env python3
"""Batch 0279 - Phase 4 bulk ingest. acts_in_force chronological-first across page-2 listings.

Per next-tick plan in batch 0278 worker.log entry / report:
(a) refresh page-2 missing pool from cached page-2 HTML AND glob-dedup against
    records/acts/<yr>/act-zm-<yr>-<num:03d>-*.json (slug-suffix-agnostic);
(b) sweep next 8 chronologically-earliest from refreshed pool avoiding gaps.md-listed items;
(c) the 1990s/2000s Appropriation series remains unstable (PDFs are scanned-OCR'd with
    variable noise) - yield will fluctuate; keep parser strict (refuse fabrication);
(d) re-verify robots.txt at start of next tick (done in tick wrapper);
(e) once page-2 pool drains, advance to next priority sub-phase (sis_corporate).

Refreshed pool: 86 inherited from batch 0278 _work/batch_0278_remaining.json.
First 8 chronological: 2001/6, 2002/6, 2002/18, 2002/19, 2003/7, 2003/8, 2004/5, 2004/6.

WARNING: All 8 picks are in the Appropriation/Supplementary Appropriation/Excess
Expenditure Appropriation fiscal-series (alpha A/S/E) which is known (per gaps.md
batch 0277/0278) to have HTML akn-section emptiness forcing PDF fallback, with
potential OCR section-regex misreads. Yield risk: lower than baseline. Parser refuses
to fabricate; items that fail will be logged to gaps.md.
...
Reuses parser from batch_0269..0278 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"2001","num":"6","title":"Appropriation Act, 2001",
     "slug":"appropriation-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"2002","num":"6","title":"Appropriation Act, 2002",
     "slug":"appropriation-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"2002","num":"18","title":"Supplementary Appropriation (1999) Act, 2002",
     "slug":"supplementary-appropriation-1999-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"2002","num":"19","title":"Supplementary Appropriation (2000) Act, 2002",
     "slug":"supplementary-appropriation-2000-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"2003","num":"7","title":"Supplementary Appropriation (2001) Act, 2003",
     "slug":"supplementary-appropriation-2001-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"2003","num":"8","title":"Appropriation Act, 2003",
     "slug":"appropriation-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"2004","num":"5","title":"Excess Expenditure Appropriation (2000) Act, 2004",
     "slug":"excess-expenditure-appropriation-2000-act","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"2004","num":"6","title":"Supplementary Appropriation (2002) Act, 2004",
     "slug":"supplementary-appropriation-2002-act","sub_phase":"acts_in_force","alpha":"S"},
]

#!/usr/bin/env python3
"""Integrity check b0516 — judgment-ingestion-worker tick.

Validates the 6 ZMSC 2024 records written this tick pass the seven required
checks from the SKILL.md non-negotiables:
...
NEW_IDS = [
    "judgment-zm-2024-zmsc-25-finsbury-investments-limited-v-murray-and-roberts",
    "judgment-zm-2024-zmsc-24-billis-farm-limited-and-anor-v-molosoni-chipabwamb",
    "judgment-zm-2024-zmsc-23-stephen-mwape-v-the-people",
    "judgment-zm-2024-zmsc-21-benson-kaunda-v-the-people",
    "judgment-zm-2024-zmsc-20-chanda-mwape-and-anor-v-the-people",
    "judgment-zm-2024-zmsc-19-francis-phiri-v-the-people",
]

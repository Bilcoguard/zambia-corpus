...
SUB_PHASE_TAG = "sis_data_protection"
...
CORPORATE_KEYWORDS = [
    # sis_data_protection scope: DPA 2021/3, ATI Act 2023/26, ECT Act 2021/4,
    # Cyber Security and Cyber Crimes Act 2021/2, ICT Act 2009/15, Electronic
    # Government Act 2021/41, Postal Services Act 2009/22 (electronic
    # communications side), Independent Broadcasting Authority Act, ZNBC.
    "data protection",
    "personal data",
    "cyber security",
    "cyber crime",
...
def main():
    ...
    a.add_argument("--alphabets", default="DACEIR")

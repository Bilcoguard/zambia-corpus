#!/usr/bin/env python3
"""Integrity check for batch-0365 (Phase 5 ZMCC ingestion).

Validates the records written by batch_0365_parse.py (driven from
_work/b0365/parse_summary.json):
...
SUMMARY = ROOT / "_work/b0365/parse_summary.json"

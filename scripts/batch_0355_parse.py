#!/usr/bin/env python3
"""Batch 0355 parser-only step.

Parses the 8 ZMCC raw HTML+PDF pairs persisted by batch_0355_fetch.py
under the tightened parser_version 0.3.0 policy locked in at b0344
(frozen from b0354 — byte-identical except for the TARGETS slice and
WORK directory).

Slice: ZMCC 2023/1 (final slot of 2023 sweep) + ZMCC 2022/{34..28}
(top-down sweep of 2022 starting from confirmed top n=34;
2022/35 confirmed 404 upstream).

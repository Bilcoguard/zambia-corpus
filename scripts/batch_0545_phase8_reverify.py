#!/usr/bin/env python3
"""
Phase 8 — Nightly re-verification: batch 0545 (fourth Phase 8 batch).

Clone of frozen baseline scripts/batch_0533_phase8_reverify.py;
only BATCH and WORKSPACE constants changed for this tick.
...
WORKSPACE = "/sessions/funny-wonderful-hawking/mnt/corpus"

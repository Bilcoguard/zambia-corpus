#!/usr/bin/env python3
"""Integrity check for batch-0369 (Phase 5 ZMCC ingestion).

Validates the records written by batch_0369_parse.py (driven from
_work/b0369/parse_summary.json):
...
SUMMARY = ROOT / "_work/b0369/parse_summary.json"

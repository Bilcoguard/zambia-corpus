#!/usr/bin/env python3
"""Batch 0268 - Phase 4 bulk ingest. acts_in_force Z residuals chronological tail (8 of 8 remaining).

Discovery this tick: re-verified robots.txt (sha256 prefix fce67b697ee4ef44 unchanged from
batches 0193-0267 -> 0268), reused alphabet=Z listing cached at
raw/zambialii/_alphabets/legislation-alphabet-Z-20260426T123515Z.html (no new fetch needed
this tick). 8 Z residuals carried forward from batch 0267 are exactly MAX_BATCH_SIZE.
Filter cross-checked (yr, num) against records/acts/**/*.json (all confirmed absent).

Picks total = 8 (MAX_BATCH_SIZE). 8 Z residuals consumed; 0 carry to next tick (alphabet=Z fully swept).

Reuses parser from batch_0267 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"1989","num":"1","title":"Zambia Centre for Accountancy Studies Act, 1989",
     "slug":"zambia-centre-for-accountancy-studies-act-1989","sub_phase":"acts_in_force","alpha":"Z"},
    {"yr":"1993","num":"25","title":"Zambia Iron and Steel Authority (Dissolution) Act, 1993",
     "slug":"zambia-iron-and-steel-authority-dissolution-act-1993","sub_phase":"acts_in_force","alpha":"Z"},
    {"yr":"1995","num":"24","title":"Zambia Institute of Diplomacy and International Studies Act, 1995",
     "slug":"zambia-institute-of-diplomacy-and-international-studies-act-1995","sub_phase":"acts_in_force","alpha":"Z"},
    {"yr":"1995","num":"36","title":"Zambia Institute of Architects Act, 1995",
     "slug":"zambia-institute-of-architects-act-1995","sub_phase":"acts_in_force","alpha":"Z"},
    {"yr":"1996","num":"10","title":"Zambia Institute of Advanced Legal Education Act, 1996",
     "slug":"zambia-institute-of-advanced-legal-education-act-1996","sub_phase":"acts_in_force","alpha":"Z"},
    {"yr":"1996","num":"11","title":"Zambia Law Development Commission Act, 1996",
     "slug":"zambia-law-development-commission-act-1996","sub_phase":"acts_in_force","alpha":"Z"},
    {"yr":"1996","num":"19","title":"Zambia Institute of Mass Communications (Repeal) Act, 1996",
     "slug":"zambia-institute-of-mass-communications-repeal-act-1996","sub_phase":"acts_in_force","alpha":"Z"},
    {"yr":"1997","num":"11","title":"Zambia Institute of Human Resources Management Act, 1997",
     "slug":"zambia-institute-of-human-resources-management-act-1997","sub_phase":"acts_in_force","alpha":"Z"},
]

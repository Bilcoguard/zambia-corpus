"""Batch 0327 — Phase 4 / minimal upstream-refresh tick (38th consecutive steady-state tick).

Inherited closing state (after b0290..b0326):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0326).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0326)
...
PROBE RESULTS (see _work/batch_0327_probe.json for full data):

  /legislation/recent:    16 act links (2026/1..8 + 2026/10 + 2025/5..9
                          + 2025/28 + 2025/29).
                          ALL 16 in corpus (steady state).
                          page bytes: 95,192 (vs b0326 94,772 — feed
                          re-ranked to lead with 2026/* entries; no new
                          act IDs appeared).
                          page sha256: 1c1bb006edda00f240e42e0fc8c0ca1804301fe4f90918c949c153ebda191665
                          (differs from b0316..b0326 due to feed
                          re-ranking, not new content).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged).
                          page sha256: 16fd6f327d1bf9f24ba74bc78c90346aa3a0118f8968bdc27b1f4af8d0a35588
...
SANDBOX NOTE (carried from b0299..b0326):
...
# The probe lives at _work/batch_0327_probe.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0326: cannot meaningfully

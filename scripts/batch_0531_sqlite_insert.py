#!/usr/bin/env python3
"""Batch 0531 — insert this tick's 3 ZMSC 2022 records into corpus.sqlite.
...
NEW_IDS = [
    "judgment-zm-2022-zmsc-11-tembo-v-chirwa-and-ors",
    "judgment-zm-2022-zmsc-08-mwachilenga-v-alistair-logistics-z-ltd",
    "judgment-zm-2022-zmsc-07-mpoha-and-anor-v-salvator",
]
...
def main():
    """TMPDIR-routed atomic copy (b0519+ precedent) to avoid FUSE journal
    cleanup errors when writing to in-place corpus.sqlite on the FUSE-mount."""
    src = ROOT / "corpus.sqlite"
    with tempfile.TemporaryDirectory(prefix="b0531_sqlite_") as tmp:

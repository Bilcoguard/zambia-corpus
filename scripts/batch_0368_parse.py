#!/usr/bin/env python3
"""Batch 0368 parser-only step (REPARSE-FIRST PASS, continuation of b0367).
...
Slice: continuation of the deferred queue, year-DESC then num-DESC.
The 2023 ZMCC backlog has been swept end-to-end across b0364..b0367
(records written for {01,02,07,10,13,15,22,24}; remaining numbers
deferred with specific reason codes). This batch pivots to the
2022 ZMCC backlog, taking the next eight raw-on-disk no-record
candidates (DESC by num):
  zmcc 2022/34, 2022/33, 2022/32, 2022/31, 2022/30, 2022/27,
  2022/25, 2022/24.
...
TARGETS = [
    ...
    # before locking the slice — see worker.log for b0368).
    # Batch 0368 (REPARSE PASS): continuation of b0367 deferred queue.
    # The 2023 ZMCC backlog has been swept end-to-end across
    # b0364..b0367 (records written for {01,02,07,10,13,15,22,24};
    # remaining numbers deferred with specific reason codes). This
    # batch pivots to the 2022 ZMCC backlog, taking the next eight
    ...
    ("zmcc", 2022, 34, "2022-02-15"),
    ("zmcc", 2022, 33, "2022-05-05"),
    ("zmcc", 2022, 32, "2022-07-15"),
    ("zmcc", 2022, 31, "2022-01-19"),
    ("zmcc", 2022, 30, "2022-11-11"),
    ("zmcc", 2022, 27, "2022-11-10"),
    ("zmcc", 2022, 25, "2022-10-21"),
    ("zmcc", 2022, 24, "2022-10-20"),
]

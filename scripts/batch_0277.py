#!/usr/bin/env python3
"""Batch 0277 - Phase 4 bulk ingest. acts_in_force chronological-first across page-2 listings.

Per next-tick plan in batch 0276 worker.log entry, sweep next 8 chronologically-earliest
from inherited 102-item page-2 missing pool (persisted in _work/batch_0276_missing.json
during batch 0276; re-deduped against on-disk records this tick to confirm 102 still
missing). No new page-2 listing fetches needed.

Page-2 missing pool (102 items) already cached during batch 0276 from
raw/zambialii/legislation/alphabet-{A,C,E,N,P,S}-page2-20260426.html. Picks span
alphabets N,S,P,A (S dominates because the 1979-1990 supplementary-appropriation series
front-loads the chronological order).
...
(verified by build of (yr,num) set across records/acts/**/*.json -> 485 tuples on disk).

Reuses parser from batch_0269..0276 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"1970","num":"55","title":"Nurses and Midwives Act, 1970",
     "slug":"nurses-and-midwives-act","sub_phase":"acts_in_force","alpha":"N"},
    {"yr":"1973","num":"41","title":"Supreme Court of Zambia Act, 1973",
     "slug":"supreme-court-of-zambia-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1979","num":"22","title":"Public Officers' Pensions (Zambia) Agreement (Implementation) Act, 1979",
     "slug":"public-officers-pensions-zambia-agreement-implementation-act","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1988","num":"21","title":"Supreme Court and High Court (Number of Judges) Act, 1988",
     "slug":"supreme-court-and-high-court-number-of-judges-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1988","num":"31","title":"Supplementary Appropriation (1987) Act, 1988",
     "slug":"supplementary-appropriation-1987-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1988","num":"32","title":"Appropriation (No. 2) Act, 1988",
     "slug":"appropriation-no-2-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1989","num":"31","title":"Supplementary Appropriation (1988) Act, 1989",
     "slug":"supplementary-appropriation-1988-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1990","num":"39","title":"Supplementary Appropriation (1989) Act, 1990",
     "slug":"supplementary-appropriation-1989-act","sub_phase":"acts_in_force","alpha":"S"},
]

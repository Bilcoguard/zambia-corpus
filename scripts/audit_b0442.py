#!/usr/bin/env python3
"""Audit-only tick batch-0442 (Phase 5 judgments).

Re-runs the same audit/integrity sweep as the prior consecutive
audit-only ticks (b0375..b0383, b0385..b0439). No fresh fetches.

Outputs:
  _work/b0442/audit_summary.json    — machine-readable result
  reports/batch-0442.md             — human report (written separately)
...
Checks:
  ...
  5. 6 random spot-recompute (deterministic seed=442)
...
def main():
    ...
    # 5. Spot-recompute (deterministic seed=442) ---------------------------

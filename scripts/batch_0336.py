"""Batch 0336 — Phase 4 / minimal upstream-refresh tick (47th consecutive steady-state tick).

Inherited closing state (after b0290..b0335):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0335).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0335)
...
PROBE RESULTS (see _work/batch_0336_probe.json for full data):
  ...
  /legislation/recent:    15 act links (2026/1..11 + 2025/6..9).
                          ...
                          (UNCHANGED for the eighth consecutive tick —
                          feed surface and ranking are byte-for-byte
                          identical to b0329..b0335).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged across all 47
                          steady-state ticks).
                          page sha256: 6f9d7206070e7e08388579bbc96174953ce58f2117793381b01e44019c24e4c9
...
SANDBOX NOTE (carried from b0299..b0335):
...
# The probe lives at _work/batch_0336_probe.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0335: cannot meaningfully

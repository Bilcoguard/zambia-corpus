#!/usr/bin/env python3
"""
Batch 0136 — Phase 4 bulk ingestion.

Continuation of the alphabetical-listing-first strategy from batches 0134–
0135. A fresh discovery step at the start of this tick scraped ZambiaLII
/legislation/?page=1..6 and filtered against a union of HEAD (555 pairs)
and pending working-tree record pairs (706 pairs total) to surface 63
absent (year, num) pairs. We skip the annual Appropriation and Excess
Expenditure Appropriation clusters and defer the Constitution of Zambia
Act, 1996 (1996/17). The first 8 substantive Acts alphabetically after
batch 0135's last target ("Decimal Currency System (Arrangements) Act,
1966") are this batch's targets:
  1. 1968/58 — Deeds of Arrangement Act, 1968
  2. 1972/35 — Development Bank of Zambia Act, 1972
  3. 1967/13 — Disposal of Uncollected Goods Act, 1967
  4. 1982/16 — District Councils Estimates Act, 1982
  5. 1966/29 — Employment (Special Provisions) Act, 1966
  6. 1996/03 — Entertainment Tax (Repeal) Act, 1996
  7. 1982/11 — Equity Levy Act, 1982
  8. 1996/08 — Estate Duty (Repeal) Act, 1996
"""
...
TARGETS = [
    (1968, 58, "deeds-of-arrangement-act-1968"),
    (1972, 35, "development-bank-of-zambia-act-1972"),
    (1967, 13, "disposal-of-uncollected-goods-act-1967"),
    (1982, 16, "district-councils-estimates-act-1982"),
    (1966, 29, "employment-special-provisions-act-1966"),
    (1996, 3,  "entertainment-tax-repeal-act-1996"),
    (1982, 11, "equity-levy-act-1982"),
    (1996, 8,  "estate-duty-repeal-act-1996"),
]
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed):
    ...
    lines = [
        ...
        "batches 0134–0135. A fresh discovery step at the start of this "
        "tick scraped ZambiaLII `/legislation/?page=1..6` and filtered "
        "against a union of HEAD (555 pairs) and working-tree record "
        "pairs (706 pairs total). That surfaced 63 absent (year, num) "
        "pairs. We skip the annual Appropriation / Excess Expenditure "
        "Appropriation clusters (28 substantive pairs remain after this "
        "filter) and defer the Constitution of Zambia Act, 1996 (1996/17) "
        "for a dedicated batch. The 8 targets here are the next "
        "substantive Acts alphabetically after batch 0135's last target "
        "(Decimal Currency System (Arrangements) Act, 1966).",
        "",
        "## Committed records",
        "",
    ...
    lines.extend([
        "## Notes",
        "",
        "- Batch 0136 discovery surfaced 63 (year, num) pairs absent from "
        "HEAD+working-tree at start of tick. 28 pairs remain after "
        "filtering out Appropriation / Excess Expenditure Appropriation "
        "clusters and the deferred 1996/17 Constitution Act. After this "
        "batch's 8, ~20 substantive Acts from pages 1–6 of /legislation/ "
        "remain queued for subsequent batches (Evidence Act 1967/8, Fees "
        "and Fines Act 1994/13, Finance (Control and Management) Act "
        "1969/24, Flying Doctor Service Act 1967/37, Gaming Machines "
        "(Prohibition) Act 1974/2, General Loans (International Bank) Act "
        "1966/35, General Loans (Mediobanca) Act 1967/19, Gwembe District "
        "Special Fund (Dissolution) Act 1968/5, Higher Authority for "
        "Power (Special Provisions) Act 1970/41, Home Guard Act 1971/32, "
        "Honours and Decorations (Prevention of Abuses) Act 1967/5, "
        "Hotels Act 1987/27, plus a tail of items further down the "
        "alphabet).",

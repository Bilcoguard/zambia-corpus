#!/usr/bin/env python3
"""
Batch 0166 — Phase 4 bulk ingestion.

Probe-only pass. Per batch 0165 next-tick plan:

    Probe rotation: tourism, fertiliser, tobacco, dairy,
    radiation, public roads, local government, chieftaincy.
...
Mirrors batch 0165 processor logic (HTML/AKN with PDF fallback +
...
# No seed candidates deferred into this batch from 0165.
SEED_CANDIDATES = []
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed,
    ...
    lines = [
        ...
        "batch-0165 next-tick plan: tourism, fertiliser, tobacco, "
        "dairy, radiation, public roads, local government, "
        "chieftaincy. Hits surviving "
    ...
    lines.extend([
        ...
        "deferred into 0166 from batch 0165.",
        ...
        "rotation of narrower probe keywords — fisheries, "
        "forests, wildlife, customary law, traditional "
        "leadership, chiefs, marriage, succession.",
        "",
    ])

"""Batch 0316 — Phase 4 / minimal upstream-refresh tick (27th consecutive steady-state tick).

Inherited closing state (after b0290..b0315):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0315).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0315)
...
PROBE RESULTS (see _work/batch_0316_probe.json for full data):
...
SANDBOX NOTE (carried from b0299..b0315):
...
Phase 4 disposition unchanged from b0293..b0315: cannot meaningfully

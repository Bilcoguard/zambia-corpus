"""Batch 0321 — Phase 4 / minimal upstream-refresh tick (32nd consecutive steady-state tick).

Inherited closing state (after b0290..b0320):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0320).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0320)
...
PROBE RESULTS (see _work/batch_0321_probe.json for full data):
  ...
  parliament page 0:      20 act links (2025/21..29 + 2026/1..11)
                          ALL 20 in corpus.
                          page sha256: 96df5e0e4ec2873121d458223a9179033cda964777c2e1cc14144aeff1917982
                          (differs from b0320 — session/CSRF token churn;
...
SANDBOX NOTE (carried from b0299..b0320):
...
Phase 4 disposition unchanged from b0293..b0320: cannot meaningfully

"""Batch 0302 — Phase 4 / minimal upstream-refresh tick (13th consecutive steady-state tick).

Inherited closing state (after b0290..b0301):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0301).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0301)
...
PROBE RESULTS (see _work/batch_0302_probe.json for full data):
...
SANDBOX NOTE (carried from b0299..b0301):
...
Phase 4 disposition unchanged from b0293..b0301: cannot meaningfully

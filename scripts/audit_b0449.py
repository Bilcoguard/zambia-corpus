#!/usr/bin/env python3
"""Audit-only tick batch-0449 (Phase 5 judgments).

Re-runs the same audit/integrity sweep as the prior consecutive
audit-only ticks (b0375..b0383, b0385..b0445). No fresh fetches.

Outputs:
  _work/b0449/audit_summary.json    — machine-readable result
  reports/batch-0449.md             — human report (written separately)
...
Checks:
  ...
  5. 6 random spot-recompute (deterministic seed=449)
...
def main():
    ...
    # 5. Spot-recompute (deterministic seed=449) ---------------------------

#!/usr/bin/env python3
"""Batch 0256 - Phase 4 bulk ingest. acts_in_force alphabets E + F.

Discovery: probed /legislation?alphabet=E&nature=act and =F this tick
(raws cached to raw/zambialii/_alphabets/legislation-alphabet-{E,F}-<ts>.html).
After filtering against the existing act IDs and dropping
amendment/appropriation/supplementary/validation/transitional/repeal/excess
expenditure tokens, 7 primary candidates remain across both alphabets — all
ingested here.

Picks (alpha, yr/num, title):
  E 1933/10 Employment of Young Persons and Children Act, 1933
  E 1963/4  English Law (Extent of Application) Act, 1963
  E 1964/31 Evidence (Bankers' Books) Act, 1964
  E 1964/43 Emergency Powers Act, 1964
  F 1937/5  Foreign Judgments (Reciprocal Enforcement) Act, 1937
  F 1949/19 Fencing Act, 1949
  F 1966/2  Factories Act, 1966

Reuses parser logic from batch_0255.py (PARSER_VERSION
0.6.0-act-zambialii-2026-04-26). Conservative 7-record batch under 8
MAX_BATCH_SIZE cap. Continues acts_in_force pivot from batches 0253/0254/0255.
"""
...
PICKS = [
    {"yr":"1933","num":"10","title":"Employment of Young Persons and Children Act, 1933",
     "slug":"employment-of-young-persons-and-children-act-1933","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1963","num":"4","title":"English Law (Extent of Application) Act, 1963",
     "slug":"english-law-extent-of-application-act-1963","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1964","num":"31","title":"Evidence (Bankers' Books) Act, 1964",
     "slug":"evidence-bankers-books-act-1964","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1964","num":"43","title":"Emergency Powers Act, 1964",
     "slug":"emergency-powers-act-1964","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1937","num":"5","title":"Foreign Judgments (Reciprocal Enforcement) Act, 1937",
     "slug":"foreign-judgments-reciprocal-enforcement-act-1937","sub_phase":"acts_in_force","alpha":"F"},
    {"yr":"1949","num":"19","title":"Fencing Act, 1949",
     "slug":"fencing-act-1949","sub_phase":"acts_in_force","alpha":"F"},
    {"yr":"1966","num":"2","title":"Factories Act, 1966",
     "slug":"factories-act-1966","sub_phase":"acts_in_force","alpha":"F"},
]

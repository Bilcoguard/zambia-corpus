#!/usr/bin/env python3
"""Batch 0280 - Phase 4 bulk ingest. acts_in_force chronological-first across page-2 listings.

Per next-tick plan in batch 0279 worker.log entry:
- Refreshed pool inherited from _work/batch_0279_remaining.json (78 items).
- Sweep next 8 chronologically-earliest from refreshed pool avoiding gaps.md-listed items.
- The 1990s/2000s Appropriation series remains unstable (PDFs scanned-OCR'd with variable noise).
- Robots.txt re-verified at start of tick (sha256 prefix fce67b697ee4ef44 unchanged from b0193..0279).

First 8 chronological from inherited pool:
  2004/7  Appropriation Act, 2004                              (alpha A)
  2005/5  Appropriation Act, 2005                              (alpha A)
  2005/6  Excess Expenditure Appropriation (2001) Act, 2005    (alpha E)
  2005/7  Excess Expenditure Appropriation (2002) Act, 2005    (alpha E)
  2005/8  Supplementary Appropriation (2003) Act, 2005         (alpha S)
  2005/21 Cotton Act, 2005                                     (alpha C - non-fiscal)
  2006/1  Supplementary Appropriation (2004) Act, 2006         (alpha S)
  2006/2  Excess Expenditure Appropriation (2003) Act, 2006    (alpha E)

WARNING: 7 of 8 picks are in the Appropriation/Supplementary Appropriation/Excess
Expenditure Appropriation fiscal-series (alpha A/S/E) which is known (per gaps.md
batches 0277-0279) to have HTML akn-section emptiness forcing PDF fallback, with
potential OCR section-regex misreads. Yield risk: lower than baseline. Parser refuses
to fabricate. The Cotton Act, 2005 (2005/21) is the lone non-fiscal pick.
...
Reuses parser from batches 0269..0279 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"2004","num":"7","title":"Appropriation Act, 2004",
     "slug":"appropriation-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"2005","num":"5","title":"Appropriation Act, 2005",
     "slug":"appropriation-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"2005","num":"6","title":"Excess Expenditure Appropriation (2001) Act, 2005",
     "slug":"excess-expenditure-appropriation-2001-act","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"2005","num":"7","title":"Excess Expenditure Appropriation (2002) Act, 2005",
     "slug":"excess-expenditure-appropriation-2002-act","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"2005","num":"8","title":"Supplementary Appropriation (2003) Act, 2005",
     "slug":"supplementary-appropriation-2003-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"2005","num":"21","title":"Cotton Act, 2005",
     "slug":"cotton-act","sub_phase":"acts_in_force","alpha":"C"},
    {"yr":"2006","num":"1","title":"Supplementary Appropriation (2004) Act, 2006",
     "slug":"supplementary-appropriation-2004-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"2006","num":"2","title":"Excess Expenditure Appropriation (2003) Act, 2006",
     "slug":"excess-expenditure-appropriation-2003-act","sub_phase":"acts_in_force","alpha":"E"},
]

#!/usr/bin/env python3
"""Batch 0276 - Phase 4 bulk ingest. acts_in_force chronological-first across page-2 listings.

Per next-tick plan in batch 0275 worker.log entry, fetch ?page=2 for alphabets
A,C,E,N,P,S (6 listing fetches) to expand the cross-alphabet residual surface, then
pick 8 chronologically-earliest missing acts. Page-2 listings cached to
raw/zambialii/legislation/alphabet-{L}-page2-20260426.html (already done at tick start
under crawl-delay 6s).

Page-2 surface enumerated 126 act entries; 110 missing from corpus after dedup against
all on-disk records/acts/**/*.json source_url /akn/zm/act/{yr}/{num} keys (476 unique
(yr,num) tuples on disk before this batch). Earliest 8 chronological picks span
alphabets E,N,P (no A,C,S in earliest 8 since earliest A page-2 entry at 1914/1 and
earliest S page-2 entry at 1973/41).
...
Reuses parser from batch_0269..0275 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"1920","num":"2","title":"Public Pounds and Trespass Act, 1920",
     "slug":"public-pounds-and-trespass-act","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1925","num":"24","title":"Export of Pigs Act, 1925",
     "slug":"export-of-pigs-act","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1929","num":"20","title":"Public Officers (Change of Titles) Act, 1929",
     "slug":"public-officers-change-of-titles-act","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1944","num":"13","title":"Extermination of Mosquitoes Act, 1944",
     "slug":"extermination-of-mosquitoes-act","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1953","num":"59","title":"Noxious Weeds Act, 1953",
     "slug":"noxious-weeds-act","sub_phase":"acts_in_force","alpha":"N"},
    {"yr":"1964","num":"14","title":"Public Holidays Act, 1964",
     "slug":"public-holidays-act","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1964","num":"56","title":"Public Seal Act, 1964",
     "slug":"public-seal-act","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1968","num":"40","title":"Notaries Public and Notarial Functions Act, 1968",
     "slug":"notaries-public-and-notarial-functions-act","sub_phase":"acts_in_force","alpha":"N"},
]

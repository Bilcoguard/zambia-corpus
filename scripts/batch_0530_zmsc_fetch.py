#!/usr/bin/env python3
"""Batch 0530 — judgment-ingestion-worker dedicated tick.

Wraps b0506 fetcher; reads targets from _work/b0530/targets.json.
Probes ZMSC 2022 num 21 (expected 404 — close inner-gap cluster bound)
and continues most-recent-first DESC sweep for nums {19..13}
(per b0529 next-tick recommendation; skipping known 404 num 20).
"""
import json
import pathlib
import sys

"""Batch 0322 — Phase 4 / minimal upstream-refresh tick (33rd consecutive steady-state tick).

Inherited closing state (after b0290..b0321):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0321).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0321)
...
PROBE RESULTS (see _work/batch_0322_probe.json for full data):
  ...
  parliament page 0:      20 act links (2025/21..29 + 2026/1..11)
                          ALL 20 in corpus.
                          page sha256: f0537e2169dc1eb6ea5c8fe59b6611d52e027204dae544384bb05d8aa61d9569
                          (differs from b0321 — session/CSRF token churn;
...
SANDBOX NOTE (carried from b0299..b0321):
...
Phase 4 disposition unchanged from b0293..b0321: cannot meaningfully

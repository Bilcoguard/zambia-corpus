#!/usr/bin/env python3
"""Batch 0365 parser-only step (REPARSE-FIRST PASS, continuation of b0364).
...
b0364's 2025/{3,2,1}+2024/{8..4} slice with the next eight
raw-on-disk candidates:
  zmcc 2024/03, 2024/02, 2024/01, 2023/27, 2023/26, 2023/25,
  2023/24, 2023/23.

(zmcc/2023/22 already in records/ — Steven Lungu v Attorney General
 and Anor; correctly skipped by the SKIP-existing guard at parse
 time, not counted in the 8.)
...
TARGETS = [
    ...
    # Batch 0365 (REPARSE PASS): continuation of b0364 deferred queue,
    ...
    ("zmcc", 2023, 27, "2023-08-03"),
    ("zmcc", 2023, 26, "2023-12-16"),
    ("zmcc", 2023, 25, "2023-12-08"),
    ("zmcc", 2023, 24, "2023-12-01"),
    ("zmcc", 2023, 23, "2023-11-07"),
]

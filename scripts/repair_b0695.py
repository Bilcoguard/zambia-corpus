#!/usr/bin/env python3
"""Repair worker batch b0695 — ZambiaLII SI repair (continuation of b0694).

Same pattern as b0694: fetches the SI AKN page, locates the source.pdf link,
downloads the PDF, and extracts body text with pdfplumber. Updates records
and rebuilds the FTS row per record (commit per record).
"""

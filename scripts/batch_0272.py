#!/usr/bin/env python3
"""Batch 0272 - Phase 4 bulk ingest. acts_in_force chronological-first across all alphabets.

Discovery this tick: re-verified robots.txt (sha256 prefix fce67b697ee4ef44 unchanged from
batches 0193-0271 -> 0272); 0 new alphabet listing fetches (all 24 A-Z listings cached;
X confirmed empty in batch 0269). Worked from 10-item residual queue carried forward by
batch 0271 worker.log; verified each (yr,num) title against cached alphabet listings
(alphabet-E-20260425.html / alphabet-P-20260425.html / alphabet-N-20260425.html) - no
fabrication. Filter cross-checked (yr,num) against records/acts/**/*.json -> all 8 confirmed
not on disk (avoided silent overwrite per BRIEF non-negotiable #4).

Picks: 6 fiscal E series (Excess Expenditure Appropriation 1991-1998 -> enacted 1994-2003)
+ 2 P (Prescribed Minerals & Materials Commission Dissolution 1993, Presidential Emoluments
Amendment 1994). Likely all PDF fallback (HTML <2 akn-sections) consistent with batches
0269/0270/0271 patterns for fiscal acts.

Picks total = 8 (MAX_BATCH_SIZE). 2 residuals carry to next tick (E 2004/4, N 2005/17).

Reuses parser from batch_0269/0270/0271 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"1993","num":"24","title":"Prescribed Minerals and Materials Commission (Dissolution) Act, 1993",
     "slug":"prescribed-minerals-and-materials-commission-dissolution-act-1993","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1994","num":"30","title":"Excess Expenditure Appropriation (1991) Act, 1994",
     "slug":"excess-expenditure-appropriation-1991-act-1994","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1994","num":"45","title":"Presidential Emoluments (Amendment) Act, 1994",
     "slug":"presidential-emoluments-amendment-act-1994","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1995","num":"32","title":"Excess Expenditure Appropriation (1992) Act, 1993",
     "slug":"excess-expenditure-appropriation-1992-act-1993","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1997","num":"22","title":"Excess Expenditure Appropriation (1993) Act, 1997",
     "slug":"excess-expenditure-appropriation-1993-act-1997","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"2000","num":"8","title":"Excess Expenditure Appropriation (1995) Act, 2000",
     "slug":"excess-expenditure-appropriation-1995-act-2000","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"2000","num":"16","title":"Excess Expenditure Appropriation (1997) Act, 2000",
     "slug":"excess-expenditure-appropriation-1997-act-2000","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"2003","num":"17","title":"Excess Expenditure Appropriation (1998) Act, 2003",
     "slug":"excess-expenditure-appropriation-1998-act-2003","sub_phase":"acts_in_force","alpha":"E"},
]

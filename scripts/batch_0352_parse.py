#!/usr/bin/env python3
"""Batch 0352 parser-only step.

Parses the 8 ZMCC 2023 raw HTML+PDF pairs persisted by
batch_0352_fetch.py under the tightened parser_version 0.3.0 policy
locked in at b0344 (frozen from b0348/b0349/b0350/b0351 — byte-identical
to b0351 except for the TARGETS slice).

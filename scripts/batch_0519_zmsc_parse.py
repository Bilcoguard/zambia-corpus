#!/usr/bin/env python3
"""Batch 0519 ZMSC parser — judgment-ingestion-worker tick.

Wraps b0506 parser: reads targets from _work/b0519/targets.json
(or argv[1]), writes records to records/judgments/zmsc/{year}/.
Outputs parse_summary.json under _work/b0519/.
"""
import pathlib
import sys

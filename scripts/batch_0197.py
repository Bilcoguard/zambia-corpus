#!/usr/bin/env python3
"""
Batch 0197 — Phase 4 sis_tax continuation.
...
TARGETS = [
    (2015,  35, "sis_tax"),   # PTT (Exemption) (No. 2) Order, 2015
    (2012,   5, "sis_tax"),   # PTT (Exemption) Order, 2012
    (2017,  40, "sis_tax"),   # Customs&Excise (Export Duty) (Suspension)
    (2022,   2, "sis_tax"),   # Customs&Excise (Suspension) (Fuel) 2022
    (2017,   2, "sis_tax"),   # Customs&Excise (Fertiliser) (Remission) 2017
    (2021,  97, "sis_tax"),   # Customs&Excise (PWD) (Remission) 2021
    (2017,  30, "sis_tax"),   # Customs&Excise (Suspension) (Cobalt Conc.)
    (2023,  10, "sis_tax"),   # Customs&Excise (Suspension) (Maize Flour)
]

# Pre-fetched discoveries in _work/ — logged once.
DISCOVERIES = [
    ("https://zambialii.org/robots.txt",
     "_work/batch_0197_robots.txt"),
    ("https://zambialii.org/legislation/subsidiary?alphabet=P",
     "_work/batch_0197_alphabet_P.html"),
    ("https://zambialii.org/legislation/subsidiary?alphabet=C",
     "_work/batch_0197_alphabet_C.html"),
]
...
def write_final_state():
    ...
    summary = {
        "batch": BATCH_NUM,
        "phase": "phase_4_bulk",
        "sub_phase": "sis_tax_continuation_ptt_plus_customs_excise",

#!/usr/bin/env python3
"""Batch 0273 - Phase 4 bulk ingest. acts_in_force chronological-first across all alphabets.

Discovery this tick: re-verified robots.txt (sha256 prefix fce67b697ee4ef44 unchanged from
batches 0193-0272 -> 0273); 0 new alphabet listing fetches (all 24 A-Z listings cached;
X confirmed empty in batch 0269; Y absent from sitemap as of batch 0272).

Per next-tick plan in batch 0272 worker.log entry, re-ran cross-alphabet residual sweep
against cached listings (raw/zambialii/legislation/alphabet-*-2026042{4,5,6}.html) and
diffed against records/acts/**/*.json on disk. Sweep identified 24 missing (yr,num)
entries. Excluded 4 known-deferred items: 1996/17 Constitution + 2006/9 Citizens Economic
Empowerment (alphabet=C deferred) and 2000/8 + 2000/16 (OCR backlog from batch 0272).
Picked 8 chronologically earliest of the 20 remaining: 1 Apprenticeship (1964) + 7
Appropriation Act fiscal series (1980-1986). All 8 verified against cached
alphabet-A-20260425.html with exact-title checks (no fabrication; per BRIEF
non-negotiable #1). Filter cross-checked (yr,num) against records/acts/**/*.json -> all
8 confirmed not on disk (avoided silent overwrite per BRIEF non-negotiable #4).

Picks total = 8 (MAX_BATCH_SIZE). 12 alphabet-A residuals carry to next tick
(Appropriation Acts 1987-1999 fiscal series; consistent runs).

Reuses parser from batch_0269/0270/0271/0272 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"1964","num":"36","title":"Apprenticeship Act, 1964",
     "slug":"apprenticeship-act-1964","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1980","num":"9","title":"Appropriation Act, 1980",
     "slug":"appropriation-act-1980","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1981","num":"12","title":"Appropriation Act, 1981",
     "slug":"appropriation-act-1981","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1982","num":"15","title":"Appropriation Act, 1982",
     "slug":"appropriation-act-1982","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1983","num":"14","title":"Appropriation Act, 1983",
     "slug":"appropriation-act-1983","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1984","num":"13","title":"Appropriation Act, 1984",
     "slug":"appropriation-act-1984","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1985","num":"16","title":"Appropriation Act, 1985",
     "slug":"appropriation-act-1985","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"1986","num":"12","title":"Appropriation Act, 1986",
     "slug":"appropriation-act-1986","sub_phase":"acts_in_force","alpha":"A"},
]

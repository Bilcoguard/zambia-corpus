#!/usr/bin/env python3
"""
Batch 0164 — Phase 4 bulk ingestion.

Probe-only pass. Per batch 0163 next-tick plan:

    Probe rotation: water, environment, communications, roads,
    traffic, lands, petroleum, banking.
...
Mirrors batch 0163 processor logic (HTML/AKN with PDF fallback +
...
No SEED candidates this batch (batch 0163 seed was standalone).
"""
...
# No seed candidates deferred into this batch from 0163.
SEED_CANDIDATES = []
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed,
    ...
    lines = [
        ...
        "batch-0163 next-tick plan: water, environment, "
        "communications, roads, traffic, lands, petroleum, "
        "banking. Hits surviving HEAD + title filters fill slots "
    ...
    lines.extend([
        "## Notes",
        "",
        "- No SEED stage this batch — batch 0163's seed "
        "(Standards Act 1994/20) was standalone and no new "
        "seed candidates were deferred into 0164.",
        ...
        "narrower probe keywords — mines and minerals, "
        "environmental management, postal, railways, civil "
        "aviation, housing, prisons, correctional.",
        "",
    ])

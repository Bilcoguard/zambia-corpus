"""Batch 0333 — Phase 4 / minimal upstream-refresh tick (44th consecutive steady-state tick).

Inherited closing state (after b0290..b0332):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0332).
  - Cumulative records: acts 1169, SIs 539, judgments 25 (all unchanged
    from b0311..b0332).
  - Long-standing pre-tick file/id gap on acts (1169 files, 1157
    unique ids) — outside this probe's integrity scope.
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0332)
...
PROBE RESULTS (see _work/batch_0333_probe.json for full data):
  ...
  /legislation/recent:    15 act links (2026/1..11 + 2025/6..9).
                          ...
                          (UNCHANGED for the fifth consecutive tick —
                          feed surface and ranking are byte-for-byte
                          identical to b0329..b0332).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged across all 44
                          steady-state ticks).
                          page sha256: 41c5c929a712cb341a679b77fd3ccdffac9706f3f36c07e4c1d13fb4a682720f
...
SANDBOX NOTE (carried from b0299..b0332):
...
# The probe lives at _work/batch_0333_probe.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0332: cannot meaningfully

"""Batch 0329 — Phase 4 / minimal upstream-refresh tick (40th consecutive steady-state tick).

Inherited closing state (after b0290..b0328):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0328).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0328)
...
PROBE RESULTS (see _work/batch_0329_probe.json for full data):

  /legislation/recent:    15 act links (2026/1..11 (no /9 was missing —
                          present as 2026/9 + 2026/11) + 2025/6..9).
                          ALL 15 in corpus (steady state).
                          page bytes: 95,392 (was 95,192 in b0327/b0328).
                          page sha256: 507f7542eddc74c7089f669398fc86861aea75d60dc9dabe0fbddb922d79321c
                          (changed vs b0328 — feed re-ranked again;
                          no novel pairs; ranking-only churn).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged).
                          page sha256: 31a9497734bf3fc19543e79fb2553aab9f710cbefb4e85add72b09ccd431acf6
...
SANDBOX NOTE (carried from b0299..b0328):
...
# The probe lives at _work/batch_0329_probe.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0328: cannot meaningfully

"""Batch 0311 — Phase 4 / minimal upstream-refresh tick (22nd consecutive steady-state tick).

Inherited closing state (after b0290..b0310):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0310).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0310)
...
PROBE RESULTS (see _work/batch_0311_probe.json for full data):
...
SANDBOX NOTE (carried from b0299..b0310):
...
Phase 4 disposition unchanged from b0293..b0310: cannot meaningfully

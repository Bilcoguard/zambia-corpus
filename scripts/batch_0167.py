#!/usr/bin/env python3
"""
Batch 0167 — Phase 4 bulk ingestion.

Probe-only pass. Per batch 0166 next-tick plan (probe yield > 2
new primary parents — continue primary-statute sweep with fresh
narrower rotation):

    Probe rotation: fisheries, forests, wildlife, customary law,
    traditional leadership, chiefs, marriage, succession.
...
Mirrors batch 0166 processor logic (HTML/AKN with PDF fallback +
...
# No seed candidates deferred into this batch from 0166.
SEED_CANDIDATES = []
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed,
    ...
    lines = [
        ...
        "batch-0166 next-tick plan: fisheries, forests, wildlife, "
        "customary law, traditional leadership, chiefs, marriage, "
        "succession. Hits surviving "
    ...
    lines.extend([
        ...
        "deferred into 0167 from batch 0166.",
        ...
        "rotation of narrower probe keywords — agriculture, "

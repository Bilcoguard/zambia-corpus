#!/usr/bin/env python3
"""Batch 0517 — judgment-ingestion-worker dedicated tick.

Wraps b0506 fetcher; reads targets from _work/b0517/targets.json by default.
Continues ZMSC 2024 most-recent-first sweep into nums 18..11
(per b0516 next-tick recommendation).
"""
import json
import pathlib
import sys

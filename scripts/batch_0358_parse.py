#!/usr/bin/env python3
"""Batch 0358 parser-only step.

Parses the 8 ZMCC raw HTML+PDF pairs persisted by batch_0357_fetch.py
under the tightened parser_version 0.3.0 policy locked in at b0344
(frozen from b0356 — byte-identical except for the TARGETS slice and
WORK directory).

Slice: ZMCC 2022/{11..4} — continuation of 2022 sweep DESC after b0357
ingested 2022/{19..12} (1 written, 7 deferred).
...
TARGETS = [
    ...
    # in the persisted raw HTML (verified against in-page Judgment date).

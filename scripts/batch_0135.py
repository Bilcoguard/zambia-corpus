#!/usr/bin/env python3
"""
Batch 0135 — Phase 4 bulk ingestion.

Target-resolution strategy: same alphabetical-listing-first approach as
batch 0134. Fresh discovery step (pages 1–6 of /legislation/) was run at the
start of this tick; 71 ZambiaLII-listed (year, num) Act pairs absent from
HEAD were identified. We skip the annual "Appropriation Act" and "Excess
Expenditure Appropriation (YYYY) Act" clusters (low legal content, high
volume — will be handled as a single dedicated batch later) and pick the
next 8 substantive Acts in alphabetical order after batch 0134's last
target (Council of Law Reporting Act, 1967). We also defer "Constitution
of Zambia Act, 1996" (1996/17) for a dedicated batch — that Act edits the
Constitution itself and deserves careful review, not bulk treatment.

Targets (8), drawn from the ZambiaLII alphabetical listing (pages 1–6),
filtered against HEAD (698 pairs), skipping Appropriation/Excess clusters
and the 1996 Constitution Act:
  1. 1985/12 — Cold Storage Board of Zambia (Dissolution) Act, 1985
  2. 1964/46 — Combined Cadet Force Act, 1964
  3. 1966/31 — Commercial Travellers (Special Provisions) Act, 1966
  4. 1969/29 — Companies (Certificates Validation) Act, 1969
  5. 1992/32 — Constitutional Offices (Emoluments) Act, 1992
  6. 1993/41 — Constitutional Offices (Emoluments) Act, 1993
  7. 1967/42 — Dangerous Drugs Act, 1967
  8. 1966/40 — Decimal Currency System (Arrangements) Act, 1966
"""
...
TARGETS = [
    (1985, 12, "cold-storage-board-of-zambia-dissolution-act-1985"),
    (1964, 46, "combined-cadet-force-act-1964"),
    (1966, 31, "commercial-travellers-special-provisions-act-1966"),
    (1969, 29, "companies-certificates-validation-act-1969"),
    (1992, 32, "constitutional-offices-emoluments-act-1992"),
    (1993, 41, "constitutional-offices-emoluments-act-1993"),
    (1967, 42, "dangerous-drugs-act-1967"),
    (1966, 40, "decimal-currency-system-arrangements-act-1966"),
]
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed):
    ...
    lines = [
        ...
        "## Strategy",
        "",
        "Same alphabetical-listing-first strategy as batch 0134. A fresh "
        "discovery step at the start of this tick scraped ZambiaLII "
        "`/legislation/?page=1..6` and filtered against HEAD's "
        "(year, num) pairs. From the 71 absent pairs surfaced, we selected "
        "the next 8 substantive Acts alphabetically after batch 0134's last "
        "target (Council of Law Reporting Act, 1967), skipping the annual "
        "Appropriation Act and Excess Expenditure Appropriation (YYYY) Act "
        "clusters (low legal content, better handled as a single dedicated "
        "batch later) and deferring the Constitution of Zambia Act, 1996 "
        "(1996/17) for a dedicated batch (it edits the Constitution itself "
        "and warrants careful individual review).",
        "",
        "## Committed records",
        "",
    ...
    lines.extend([
        "## Notes",
        "",
        "- Batch 0135 discovery (pages 1–6 of /legislation/) surfaced 71 "
        "(year, num) pairs absent from HEAD at start of tick. The 8 targets "
        "here are the next alphabetical substantive Acts; the remaining 63 "
        "absent pairs (dominated by Appropriation / Excess Expenditure "
        "Appropriation annual Acts plus a handful of substantive items "
        "further down the alphabet) remain queued for subsequent batches.",
        "- Deferred for dedicated batches: Constitution of Zambia Act, 1996 "
        "(1996/17), and the full Appropriation / Excess Expenditure "

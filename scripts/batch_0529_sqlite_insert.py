#!/usr/bin/env python3
"""Batch 0529 — insert this tick's 1 ZMSC 2022 record into corpus.sqlite.
...
NEW_IDS = [
    "judgment-zm-2022-zmsc-29-mutale-v-african-banking-corporation-ltd",
]
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="b0529_sqlite_") as tmp:

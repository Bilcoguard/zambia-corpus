#!/usr/bin/env python3
"""Integrity check b0517 — judgment-ingestion-worker tick.

Validates the 6 ZMSC 2024 records written this tick (nums 12..17) pass the
seven required checks from the SKILL.md non-negotiables:
...
NEW_IDS = [
    "judgment-zm-2024-zmsc-17-mbinji-mbinji-v-the-people",
    "judgment-zm-2024-zmsc-16-innocent-kahyata-v-zesco-limited",
    "judgment-zm-2024-zmsc-15-gladson-moono-v-the-people",
    "judgment-zm-2024-zmsc-14-dickson-shamboko-and-anor-v-the-people",
    "judgment-zm-2024-zmsc-13-mike-muloba-v-the-people",
    "judgment-zm-2024-zmsc-12-kalaluka-mushoke-v-the-people",
]

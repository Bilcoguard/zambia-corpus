#!/usr/bin/env python3
"""Integrity check b0521 — judgment-ingestion-worker tick.

Validates the 6 ZMSC 2023 records written this tick (nums 9, 8, 7, 6, 5, 4)
...
def main():
    ...
    print(f"Integrity check b0521: {passed} passed / {failed} failed")
    if errors:
        for e in errors:
            print(f"  FAIL: {e}")
        sys.exit(1)

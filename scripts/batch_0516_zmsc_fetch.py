#!/usr/bin/env python3
"""Batch 0516 — judgment-ingestion-worker dedicated tick.

Wraps b0506 fetcher; reads targets from _work/b0516/targets.json by default.
Continues ZMSC 2024 most-recent-first sweep into nums 26..19 (per b0515 next-tick recommendation).
"""
import json
import pathlib
import sys

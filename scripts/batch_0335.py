"""Batch 0335 — Phase 4 / minimal upstream-refresh tick (46th consecutive steady-state tick).

Inherited closing state (after b0290..b0334):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0334).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0334)
...
PROBE RESULTS (see _work/batch_0335_probe.json for full data):
  ...
  /legislation/recent:    15 act links (2026/1..11 + 2025/6..9).
                          ...
                          (UNCHANGED for the seventh consecutive tick —
                          feed surface and ranking are byte-for-byte
                          identical to b0329..b0334).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged across all 46
                          steady-state ticks).
                          page sha256: 849bc15ea3e2f126de0a019f7837e08e68c18ac32063de1ce294861d4c9a640b
...
INTEGRITY (lightweight, on records/{type}/**/*.json):
  ...
  hash.sampled:    50  (raw files not present locally for sample;
                        ...
                        1 raw file resolvable in sandbox, 49 deferred)
  hash.mismatch:   0

SANDBOX NOTE (carried from b0299..b0334):
...
# The probe lives at _work/batch_0335_probe.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0334: cannot meaningfully

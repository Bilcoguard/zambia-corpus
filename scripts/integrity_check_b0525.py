#!/usr/bin/env python3
"""Integrity check b0525 — judgment-ingestion-worker tick.

Validates the 4 ZMSC 2022 records written this tick (nums 45, 42, 40, 39)
...
def main():
    ...
    print(f"Integrity check b0525: {passed} passed / {failed} failed")
    if errors:
        for e in errors:
            print(f"  FAIL: {e}")
        sys.exit(1)

#!/usr/bin/env python3
"""Batch 0347 — Phase 5 ZMCC ingestion (continuation of ZMCC 2025 sweep).

Slice next-after b0345: ZMCC 2025/{18,17,16,15,14,13,12,11}, going
most-recent-first.

Improvement over b0345 fetcher: dates discovered at fetch time by hitting
the dateless canonical URL (`/akn/zm/judgment/zmcc/2025/N/eng`), which
ZambiaLII 302-redirects to the dated form. This removes the need to
hand-curate dates ahead of time and is one extra HTTP request per
candidate (8 redirects total) — well within today's budget.

"""Batch 0319 — Phase 4 / minimal upstream-refresh tick (30th consecutive steady-state tick).

Inherited closing state (after b0290..b0318):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0318).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0318)
...
PROBE RESULTS (see _work/batch_0319_probe.json for full data):
  ...
  /legislation/recent:    13 act links (2025/5..9 + 2025/22..29)
                          ...
                          (unchanged from b0316..b0318).
  parliament page 0:      20 act links (2025/21..29 + 2026/1..11)
                          ALL 20 in corpus.
                          page sha256: 4dbcbb0e2c834b419e3040ee2d41dab982d4c4729cb37201fff31a0eb30d4443
                          (differs from b0318 — session/CSRF token churn;
...
SANDBOX NOTE (carried from b0299..b0318):
  ...
  - parliament.gov.zm does not send the RapidSSL TLS RSA CA G1
    ...
    used.
  - .git/index.lock cleared via _stale_locks/ rotation pre-commit
    (sandbox cannot delete with rm; mv works).
"""
...
Phase 4 disposition unchanged from b0293..b0318: cannot meaningfully

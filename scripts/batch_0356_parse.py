#!/usr/bin/env python3
"""Batch 0356 parser-only step.

Parses the 8 ZMCC raw HTML+PDF pairs persisted by batch_0356_fetch.py
under the tightened parser_version 0.3.0 policy locked in at b0344
(frozen from b0355 — byte-identical except for the TARGETS slice and
WORK directory).

Slice: ZMCC 2022/{27..20} — continuation of 2022 sweep DESC after b0355
ingested 2022/{34..28}.

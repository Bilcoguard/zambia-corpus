#!/usr/bin/env python3
"""Integrity check b0518 — judgment-ingestion-worker tick.

Validates the 4 ZMSC 2024 records written this tick (nums 10, 8, 7, 3) pass
the seven required checks from the SKILL.md non-negotiables:
...
NEW_IDS = [
    "judgment-zm-2024-zmsc-10-astro-holding-limited-and-ors-v-edgar-hamulele-sue",
    "judgment-zm-2024-zmsc-08-peter-katampi-and-ors-v-the-people",
    "judgment-zm-2024-zmsc-07-faustin-kabwe-and-bimal-thaker-v-ndola-trust-schoo",
    "judgment-zm-2024-zmsc-03-masautso-banda-v-the-people",
]

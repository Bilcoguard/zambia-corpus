#!/usr/bin/env python3
"""Batch 0271 - Phase 4 bulk ingest. acts_in_force chronological-first across all alphabets.

Discovery this tick: re-verified robots.txt (sha256 prefix fce67b697ee4ef44 unchanged from
batches 0193-0270 -> 0271); 0 new alphabet listing fetches (all 24 A-Z listings cached;
X confirmed empty in batch 0269; no W/V/Y/Z residuals after batch 0268 sweep). Performed
cross-alphabet residual sweep using cached listings (B-Z, less X), filtering candidates
against records/acts/**/*.json by (yr,num). 18 non-deferred residuals identified (matches batch 0270 forecast); 8 picked
chronologically by (yr,num). Excludes 3 known-deferred items: 1956/4 S (disambiguator),
1996/17 C (Constitution - large), 2006/9 C (CEE - large).

Picks: 7 fiscal E/S series (Appropriation/Excess Expenditure 1987-1992) + 1 P (Prices and Incomes Commission Dissolution 1993).
Likely all PDF fallback (HTML <2 akn-sections) consistent with batch 0269 pattern.

Picks total = 8 (MAX_BATCH_SIZE). 10 residuals carry to next tick.

Reuses parser from batch_0269 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"1987","num":"13","title":"Excess Expenditure Appropriation (1984) Act, 1987",
     "slug":"excess-expenditure-appropriation-1984-act-1987","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1988","num":"14","title":"Excess Expenditure Appropriation (1985) Act, 1988",
     "slug":"excess-expenditure-appropriation-1985-act-1988","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1988","num":"15","title":"Supplementary Appropriation (1986) Act, 1988",
     "slug":"supplementary-appropriation-1986-act-1988","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1988","num":"30","title":"Excess Expenditure Appropriation (1986) Act, 1988",
     "slug":"excess-expenditure-appropriation-1986-act-1988","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1989","num":"32","title":"Excess Expenditure Appropriation (1987) Act, 1989",
     "slug":"excess-expenditure-appropriation-1987-act-1989","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1990","num":"38","title":"Excess Expenditure Appropriation (1988) Act, 1990",
     "slug":"excess-expenditure-appropriation-1988-act-1990","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1992","num":"15","title":"Excess Expenditure Appropriation (1989) Act, 1992",
     "slug":"excess-expenditure-appropriation-1989-act-1992","sub_phase":"acts_in_force","alpha":"E"},
    {"yr":"1993","num":"20","title":"Prices and Incomes Commission (Dissolution) Act, 1993",
     "slug":"prices-and-incomes-commission-dissolution-act-1993","sub_phase":"acts_in_force","alpha":"P"},
]

"""Batch 0325 — Phase 4 / minimal upstream-refresh tick (36th consecutive steady-state tick).

Inherited closing state (after b0290..b0324):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0324).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0324)
...
PROBE RESULTS (see _work/batch_0325_probe.json for full data):
  ...
  parliament page 0:      20 act links (2025/21..29 + 2026/1..11)
                          ALL 20 in corpus.
                          page sha256: 5eef5a6c5f8083b9... (differs
                          from b0324 — session/CSRF token churn;
...
SANDBOX NOTE (carried from b0299..b0324):
...
# The probe lives at _work/batch_0325_probe.py (gitignored).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0324: cannot meaningfully

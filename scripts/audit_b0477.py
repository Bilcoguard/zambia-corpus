#!/usr/bin/env python3
"""Audit-only tick batch-0477 (Phase 5 judgments).

Re-runs the same audit/integrity sweep as the prior consecutive
audit-only ticks (b0375..b0383, b0385..b0464). No fresh fetches.

Outputs:
  _work/b0477/audit_summary.json    — machine-readable result
  reports/batch-0477.md             — human report (written separately)
...
Checks:
  ...
  5. 6 random spot-recompute (deterministic seed=477)
...
def main():
    ...
    # 5. Spot-recompute (deterministic seed=477) ---------------------------

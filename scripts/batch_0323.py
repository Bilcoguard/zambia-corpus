"""Batch 0323 — Phase 4 / minimal upstream-refresh tick (34th consecutive steady-state tick).

Inherited closing state (after b0290..b0322):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0322).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0322)
...
PROBE RESULTS (see _work/batch_0323_probe.json for full data):
  ...
  /legislation/recent:    13 act links (2025/5..9 + 2025/22..29)
                          ...
                          page bytes: 94,772 (unchanged).
  parliament page 0:      20 act links (2025/21..29 minus 2025/28-also-listed
                          + 2026/1..11)
                          ALL 20 in corpus.
                          page sha256: e5efaa5d2f9ae0cab1be2133a867811e133e05a45d377a192cef82e0342fbc21
                          (differs from b0322 — session/CSRF token churn;
                           byte-count 38,208 unchanged).
...
SANDBOX NOTE (carried from b0299..b0322):
...
Phase 4 disposition unchanged from b0293..b0322: cannot meaningfully

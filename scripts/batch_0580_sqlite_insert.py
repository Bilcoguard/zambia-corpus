#!/usr/bin/env python3
"""Batch 0579 — insert this tick's 3 ZMSC 2020 records into corpus.sqlite.
...
NEW_IDS = [
    "judgment-zm-2020-zmsc-120-susan-mwale-harman-v-bank-of-zambia",
    "judgment-zm-2020-zmsc-130-muzyamba-v-sinabbomba-and-ors",
    "judgment-zm-2020-zmsc-150-mulenga-v-people",
]
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="b0579_sqlite_") as tmp:

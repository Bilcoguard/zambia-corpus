#!/usr/bin/env python3
"""
Batch 0141 — Phase 4 bulk ingestion.

Continuation of the J/K/L/M/N block work from batch 0140, drawing from
the discovery queue persisted at `_work/batch_0140_discovery.json` and
adding adjacent N-R primary statutes resolved via the ZambiaLII search
API. Eight targets selected, all primary statutes (no amendment acts,
no appropriation acts):

  1. 2007/20  — Matrimonial Causes Act, 2007
  2. 1970/2   — Lands Acquisition Act, 1970
  3. 1973/39  — Forests Act, 1973
  4. 2003/14  — Zambia Institute of Marketing Act, 2003
  5. 2002/12  — Public Roads Act, 2002
  6. 1996/35  — Public Service Pensions Act, 1996
  7. 2006/12  — Electoral Act, 2006
  8. 1958/37  — Roads and Road Traffic Act, 1958
...
TARGETS = [
    (2007, 20, "matrimonial-causes-act-2007"),
    (1970, 2,  "lands-acquisition-act-1970"),
    (1973, 39, "forests-act-1973"),
    (2003, 14, "zambia-institute-of-marketing-act-2003"),
    (2002, 12, "public-roads-act-2002"),
    (1996, 35, "public-service-pensions-act-1996"),
    (2006, 12, "electoral-act-2006"),
    (1958, 37, "roads-and-road-traffic-act-1958"),
]
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed):
    ...
    lines = [
        ...
        "0134–0140. Targets drawn from the `_work/batch_0140_discovery.json` "
        "queue (J/K/L/M candidates) plus adjacent N-R primary statutes "
        "resolved via the ZambiaLII search API "
        "(`/search/api/documents/?search=<q>&nature=Act`). Eight targets "
        "selected (all primary statutes, no amendment acts, no "
        "appropriation acts): Matrimonial Causes 2007/20, Lands "
        "Acquisition 1970/2, Forests 1973/39, Zambia Institute of "
        "Marketing 2003/14, Public Roads 2002/12, Public Service "
        "Pensions 1996/35, Electoral 2006/12, Roads and Road Traffic "
        "1958/37. Fetched via AKN URL pattern with PDF fallback when "
        "HTML returned fewer than 2 parsed sections.",
        "",
        "## Committed records",
        "",
    ...
    lines.extend([
        "## Notes",
        "",
        "- Next tick: continue N-R block — Public Roads (2002/12 done "
        "this batch), Public Service Pensions (done), then tackle "
        "Roads and Road Traffic repeal/amendment chain, National Parks "
        "and Wildlife (2015 recast), National Health Insurance 2018, "
        "National Council for Construction 2003 predecessor vs 2020 "
        "recast, Public Finance Management Act 2018 (Act 1/2018), "
        "Public Procurement Act 2020 (Act 8/2020).",
        "- Roads and Road Traffic Act 1958 is superseded by the Road "
        "Traffic Act 2002 (2002/11, not yet in HEAD) — historical "
        "primary included for completeness; cross-ref links deferred to "
        "a future amendment-linking batch.",
        "",
    ])

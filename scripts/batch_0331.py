"""Batch 0331 — Phase 4 / minimal upstream-refresh tick (42nd consecutive steady-state tick).

Inherited closing state (after b0290..b0330):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0330).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0330)
...
PROBE RESULTS (see _work/batch_0331_probe.json for full data):
  ...
  /legislation/recent:    15 act links (2026/1..11 + 2025/6..9).
                          ...
                          (UNCHANGED for the third consecutive tick —
                          feed surface and ranking are byte-for-byte
                          identical to b0329..b0330).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged across all 42
                          steady-state ticks).
                          page sha256: 278701d7388348d1d38d9a1c878e1bca45eec5a6fcbaa607317ab5c6ad5148d3
...
SANDBOX NOTE (carried from b0299..b0330):
...
# The probe lives at _work/batch_0331_probe.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0330: cannot meaningfully

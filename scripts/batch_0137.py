#!/usr/bin/env python3
"""
Batch 0137 — Phase 4 bulk ingestion.

Continuation of the alphabetical-listing-first strategy from batches 0134–
0136. Targets drawn directly from batch 0136's next-tick list (worker.log
2026-04-19T03:40:13Z): the next 8 substantive Acts alphabetically after
"Estate Duty (Repeal) Act, 1996" in the ZambiaLII /legislation/ alphabetical
ordering:
  1. 1967/8  — Evidence Act, 1967
  2. 1994/13 — Fees and Fines Act, 1994
  3. 1969/24 — Finance (Control and Management) Act, 1969
  4. 1967/37 — Flying Doctor Service Act, 1967
  5. 1974/2  — Gaming Machines (Prohibition) Act, 1974
  6. 1966/35 — General Loans (International Bank) Act, 1966
  7. 1967/19 — General Loans (Mediobanca) Act, 1967
  8. 1968/5  — Gwembe District Special Fund (Dissolution) Act, 1968
...
TARGETS = [
    (1967, 8,  "evidence-act-1967"),
    (1994, 13, "fees-and-fines-act-1994"),
    (1969, 24, "finance-control-and-management-act-1969"),
    (1967, 37, "flying-doctor-service-act-1967"),
    (1974, 2,  "gaming-machines-prohibition-act-1974"),
    (1966, 35, "general-loans-international-bank-act-1966"),
    (1967, 19, "general-loans-mediobanca-act-1967"),
    (1968, 5,  "gwembe-district-special-fund-dissolution-act-1968"),
]
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed):
    ...
    lines = [
        ...
        "batches 0134–0136. Targets drawn directly from batch 0136's "
        "next-tick list: the next 8 substantive Acts alphabetically after "
        "\"Estate Duty (Repeal) Act, 1996\" in the ZambiaLII /legislation/ "
        "ordering — Evidence (1967/8), Fees and Fines (1994/13), Finance "
        "(Control and Management) (1969/24), Flying Doctor Service "
        "(1967/37), Gaming Machines (Prohibition) (1974/2), General Loans "
        "(International Bank) (1966/35), General Loans (Mediobanca) "
        "(1967/19), Gwembe District Special Fund (Dissolution) (1968/5). "
    ...
    lines.extend([
        "## Notes",
        "",
        "- After this batch, remaining queued from batch 0136's discovery "
        "tail: Higher Authority for Power (Special Provisions) Act 1970/41, "
        "Home Guard Act 1971/32, Honours and Decorations (Prevention of "
        "Abuses) Act 1967/5, Hotels Act 1987/27, plus the items further "
        "down the alphabet (I–L blocks).",

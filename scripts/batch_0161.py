#!/usr/bin/env python3
"""
Batch 0161 — Phase 4 bulk ingestion.

Probe-only pass. Rotates the ZambiaLII search-API queries to the
next set flagged by batch 0160's next-tick plan:

    mining act, fisheries, agriculture, marketing,
    statistics, companies act, investment, referendum
...
Mirrors batch 0160 processor logic (HTML/AKN with PDF fallback +
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed,
    ...
    lines = [
        ...
        "batch-0160 next-tick plan. Stage 2 probes the "
    ...
    lines.extend([
        "## Notes",
        "",
        "- No SEED stage this batch — batch 0160 next-tick "
        ...
        "primary-statute sweep with a fresh rotation of "
        "narrower probe keywords — forestry, veterinary, "
        "animal health, education, legal practitioners, "
        "public health, food and drugs, land survey.",
        "",
    ])

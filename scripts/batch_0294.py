"""Batch 0294 — Phase 4 / minimal upstream-refresh tick.

Inherited closing state (after b0290..b0293):
  ...
  - OCR backlog: 21 (unchanged from b0293).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0293)
...
PROBE RESULTS (see _work/batch_0294_probe.json for full data):
...
Phase 4 disposition unchanged from b0293: cannot meaningfully advance

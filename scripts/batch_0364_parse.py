#!/usr/bin/env python3
"""Batch 0364 parser-only step (REPARSE-FIRST PASS, continuation of b0363).
...
picking candidates whose record was never written. Picks up after
b0363's 2025/{12..05} slice with the next eight raw-on-disk
candidates:
  zmcc 2025/03, 2025/02, 2025/01, 2024/08, 2024/07, 2024/06,
  2024/05, 2024/04.

(zmcc/2025/04 already in records/ — Brenda Mpashi v Attorney General;
 zmcc/2024/09 already in records/ — Hastie Sibanda v Attorney General;
 both correctly skipped by the SKIP-existing guard at parse time.)
...
TARGETS = [
    ...
    # before locking the slice — see worker.log for b0364).
    # Batch 0364 (REPARSE PASS): continuation of b0363 deferred queue,
    # year-DESC then num-DESC. All raw HTML+PDF already on disk from
    # earlier batches; this run consumes zero fetch budget.
    ("zmcc", 2025,  3, "2025-03-06"),
    ("zmcc", 2025,  2, "2025-02-06"),
    ("zmcc", 2025,  1, "2025-02-13"),
    ("zmcc", 2024,  8, "2024-06-07"),
    ("zmcc", 2024,  7, "2024-06-06"),
    ("zmcc", 2024,  6, "2024-04-16"),

...
Continue ZMCC 2022 sweep DESC: 2022/{27..20} (8 candidates).

Frozen from b0355 fetcher logic (byte-identical except for defaults
and the WORK directory). Top-of-2022 already discovered at n=34 by
b0355 (n=35 returned upstream 404). 2022/{34..28} already on disk,
this tick continues from 2022/27 down to 2022/20.

"""Batch 0297 — Phase 4 / minimal upstream-refresh tick.

Inherited closing state (after b0290..b0296):
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0296)
...
PROBE RESULTS (see _work/batch_0297_probe.json for full data):

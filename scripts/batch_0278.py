#!/usr/bin/env python3
"""Batch 0278 - Phase 4 bulk ingest. acts_in_force chronological-first across page-2 listings.

Per next-tick plan in batch 0277 worker.log entry:
(a) refresh page-2 missing pool from cached page-2 HTML AND glob-dedup against
    records/acts/<yr>/act-zm-<yr>-<num:03d>-*.json (catches stealth duplicates like
    1988/21 which was missed by /akn/zm/act/<yr>/<num> source_url-only dedup);
(b) sweep next 8 chronologically-earliest from refreshed pool avoiding gaps.md-listed
    items (1988/21 duplicate-existing, 1988/32 pdf_parse_no_sections).

Refreshed pool: 102 inherited from batch 0277 _work/batch_0277_remaining.json
- 6 already on-disk (committed in batch 0277: 1970/55, 1973/41, 1979/22, 1988/31, 1989/31, 1990/39)
- 2 gaps-flagged (1988/21, 1988/32)
= 94 candidates remaining for batch 0278+
First 8 chronological: 1992/16, 1993/29, 1994/40, 1995/33, 1997/23, 1997/29, 2000/11, 2001/5

WARNING: ALL 8 PICKS are in the Appropriation/Supplementary Appropriation fiscal-series
which is known (per gaps.md batch 0277 + batch 0272) to have HTML akn-section emptiness
forcing PDF fallback, with potential OCR section-regex misreads (e.g. "1." -> "i.").
Yield risk: lower than baseline acts_in_force series. Parser refuses to fabricate;
items that fail will be logged to gaps.md for OCR-tolerant regex follow-up (deferred).

Pre-flight: each pick verified to have exactly 1 matching href in cached page-2 HTML
(no disambiguator collision). Pre-flight on-disk check: all 8 confirmed not present
via glob act-zm-<yr>-<num:03d>-*.json (slug-suffix-agnostic).

Reuses parser from batch_0269..0277 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
"""
...
PICKS = [
    {"yr":"1992","num":"16","title":"Supplementary Appropriation (1990) Act, 1992",
     "slug":"supplementary-appropriation-1990-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1993","num":"29","title":"Supplementary Appropriation (1991) Act, 1993",
     "slug":"supplementary-appropriation-1991-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1994","num":"40","title":"Supplementary Appropriation (1992) Act, 1994",
     "slug":"supplementary-appropriation-1992-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1995","num":"33","title":"Supplementary Appropriation (1993) Act, 1995",
     "slug":"supplementary-appropriation-1993-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1997","num":"23","title":"Supplementary Appropriation (1994) Act, 1997",
     "slug":"supplementary-appropriation-1994-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"1997","num":"29","title":"Supplementary Appropriation (1995) Act, 1997",
     "slug":"supplementary-appropriation-1995-act","sub_phase":"acts_in_force","alpha":"S"},
    {"yr":"2000","num":"11","title":"Appropriation Act, 2000",
     "slug":"appropriation-act","sub_phase":"acts_in_force","alpha":"A"},
    {"yr":"2001","num":"5","title":"Supplementary Appropriation (1998) Act, 2001",
     "slug":"supplementary-appropriation-1998-act","sub_phase":"acts_in_force","alpha":"S"},
]
...
def slug_glob_exists(yr, num):
    """Slug-suffix-agnostic on-disk dedup (catches stealth duplicates like b0277 1988/21)."""
...
def ingest_one(pick):
    ...
    # Slug-agnostic pre-flight dedup

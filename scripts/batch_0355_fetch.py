...
Two-part walk for this tick:
  Part A: probe ZMCC 2023/1 — only 2023 number not yet attempted.
  Part B: discover ZMCC 2022 top by probing from high number DESC,
          honouring MAX_HITS=8 (minus part-A successes) and stopping
          after STOP_ON_404_RUN consecutive 404s.

Frozen from b0354 fetcher logic:

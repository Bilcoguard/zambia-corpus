#!/usr/bin/env python3
"""
Repair batch 0650 — continues b0649's drainage of Condition-B SIs.

Pattern (per b0641/b0643/b0644/b0645/b0647/b0648/b0649):
...
WORKDIR = "/sessions/hopeful-bold-carson/tmp/repair_b0650"
DB = "/sessions/hopeful-bold-carson/mnt/corpus/corpus.sqlite"
CRAWL_DELAY = 5
PARSER_VERSION = "repair-0.6.1"

# Next 8 Condition-B SIs continuing alphabetically from b0649's 2017/031 cohort.
TARGETS = [
    "si-zm-2017-050-citizenship-of-zambia-regulations-2017",
    "si-zm-2017-053-constitution-of-zambia-act-proclamation-declaration-of-threatened-state-of-public-security-2017",
    "si-zm-2017-054-electoral-process-local-government-by-elections-election-date-and-times-of-poll-order-2017",
    "si-zm-2017-055-preservation-of-public-security-regulations-2017",
    "si-zm-2017-060-urban-and-regional-planning-designated-local-planning-authorities-regulations-2017",
    "si-zm-2017-063-local-forest-no-42-kawena-cessation-order-2017",
    "si-zm-2017-064-urban-and-regional-planning-designated-local-planning-authorities-no-2-regulations-2017",
    "si-zm-2017-077-national-markets-and-bus-stations-development-fund-regulations-2017",
]

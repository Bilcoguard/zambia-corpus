#!/usr/bin/env python3
"""Integrity check for batch-0353 (Phase 5 ZMCC ingestion).

Validates the records written by batch_0353_parse.py (driven from
_work/b0353/parse_summary.json):
...
SUMMARY = ROOT / "_work/b0353/parse_summary.json"

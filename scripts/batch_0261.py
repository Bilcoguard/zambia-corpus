#!/usr/bin/env python3
"""Batch 0261 - Phase 4 bulk ingest. acts_in_force alphabets P + Q + R.

Discovery: probed /legislation?alphabet={P,Q,R}&nature=act this tick
(raws cached to raw/zambialii/_alphabets/legislation-alphabet-{P,Q,R}-<ts>.html).
After filtering against existing 952 act IDs (cross-referenced on yr/num) and
dropping amendment/appropriation/supplementary/validation/transitional/repeal/
continuation/excess-expenditure/dissolution/rectification tokens, candidates
remain across P (9 primary), Q (1) and R (3). Capped at MAX_BATCH_SIZE = 8 --
residuals deferred to next tick.

Picks (alpha, yr/num, title):
  P 1981/2   Presidential Emoluments Act, 1981
  P 1947/31  Printed Publications Act, 1947
  P 1992/21  Privatisation Act, 1992
  P 1961/37  Professional Boxing and Wrestling Control Act, 1961
  P 1960/6   Protected Places and Areas Act, 1960
  P 1965/8   Provincial and District Boundaries Act, 1965
  Q 1995/37  Quantity Surveyors Act, 1995
  R 1994/25  Radiocommunications Act, 1994

Reuses parser logic from batch_0260.py (PARSER_VERSION
0.6.0-act-zambialii-2026-04-26). 8-record batch at MAX_BATCH_SIZE = 8 cap.
Continues acts_in_force alphabetic walk from batches 0253-0260.
"""
...
PICKS = [
    {"yr":"1981","num":"2","title":"Presidential Emoluments Act, 1981",
     "slug":"presidential-emoluments-act-1981","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1947","num":"31","title":"Printed Publications Act, 1947",
     "slug":"printed-publications-act-1947","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1992","num":"21","title":"Privatisation Act, 1992",
     "slug":"privatisation-act-1992","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1961","num":"37","title":"Professional Boxing and Wrestling Control Act, 1961",
     "slug":"professional-boxing-and-wrestling-control-act-1961","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1960","num":"6","title":"Protected Places and Areas Act, 1960",
     "slug":"protected-places-and-areas-act-1960","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1965","num":"8","title":"Provincial and District Boundaries Act, 1965",
     "slug":"provincial-and-district-boundaries-act-1965","sub_phase":"acts_in_force","alpha":"P"},
    {"yr":"1995","num":"37","title":"Quantity Surveyors Act, 1995",
     "slug":"quantity-surveyors-act-1995","sub_phase":"acts_in_force","alpha":"Q"},
    {"yr":"1994","num":"25","title":"Radiocommunications Act, 1994",
     "slug":"radiocommunications-act-1994","sub_phase":"acts_in_force","alpha":"R"},
]

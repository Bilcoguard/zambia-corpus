...
Continue ZMCC 2022 sweep DESC: 2022/{19..12} (8 candidates).

Frozen from b0356 fetcher logic (byte-identical except for defaults
and the WORK directory). 2022/{34..20} already on disk after b0355/b0356;
this tick continues from 2022/19 down to 2022/12.

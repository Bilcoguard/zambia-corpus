#!/usr/bin/env python3
"""
Batch 0190 — Phase 4 case_law_scz continuation (mid-2025 corridor, block 3).

Continues case_law_scz (priority_order item 5) per the batch 0189 next-tick
plan — "continue case_law_scz mid-2025 corridor (zmsc/2025/16, 15, 13, 12,
11, 10, 9, 8 ...)" — 8 targets, all discovered via the cached ZambiaLII
ZMSC index raw/zambialii/judgments/zmsc/zmsc-index-page-1-20260424.html.

ZMSC 2025/14 is deliberately skipped — absent from the cached index page
(no /akn/zm/judgment/zmsc/2025/14/ link surfaced during the batch-0188
discovery step; the slot appears unused in the AKN listing).

Target slots (8 × 2 fetches = 16 AKN HTML + PDF):

  - zmsc/2025/16  The Attorney General v Rajan Mahthani (Appeal 4/2020)   2025-07-24
  - zmsc/2025/15  AG and Anor v Metro Investments (Appeal 9/2021; SCZ)   2025-07-25
  - zmsc/2025/13  Zambia China Economic Trade Coop v Zambia Jihai Agri   2025-05-19
  - zmsc/2025/12  Pemba Lapidaries v William Saunders (SCZ/8/28/2023)    2025-05-21
  - zmsc/2025/11  Henry Nyambe and 9 Ors v Lumwana Mining                2025-04-29
  - zmsc/2025/10  Thelma Maunga (admin estate Suzyo Nyika)               2025-04-17
  - zmsc/2025/9   Attorney General v Rajan Mahthani (Appeal 4/2020)      2025-04-08
  - zmsc/2025/8   Faustine Kabwe v Ndola Trust School                    2025-03-28

Note: zmsc/2025/9 and zmsc/2025/16 are both "(Attorney General) v Rajan
Mahthani (Appeal No. 4 of 2020)" but deliver distinct rulings on
2025-04-08 and 2025-07-24 respectively. Record IDs differ by the
ZMSC number prefix so there is no slot collision.
...
--slice=START:END with a _work/batch_0190_summary.json resume checkpoint.
"""
import argparse
import hashlib
import io

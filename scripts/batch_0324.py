"""Batch 0324 — Phase 4 / minimal upstream-refresh tick (35th consecutive steady-state tick).

Inherited closing state (after b0290..b0323):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0323).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0323)
...
PROBE RESULTS (see _work/batch_0324_probe.json for full data):
  ...
  parliament page 0:      20 act links (2025/21..29 + 2026/1..11)
                          ALL 20 in corpus.
                          page sha256: 98ff20677bc9645b... (differs
                          from b0323 — session/CSRF token churn;
...
SANDBOX NOTE (carried from b0299..b0323):
...
Phase 4 disposition unchanged from b0293..b0323: cannot meaningfully

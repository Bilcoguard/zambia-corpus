...
Workflow:
  ...
  4. Ingest up to MAX_BATCH_SIZE = 7 records using the same path that
     batches 0201-0204 followed (HTML → PDF → pdfplumber sectioning →
     CHECK1-5).

MAX_BATCH_SIZE = 7 records hard cap. Crawl delay = 6 s (margin over the
...
def main():
    ...
    a.add_argument("--alphabets", default="NEPF")

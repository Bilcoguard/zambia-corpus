"""Batch 0315 — Phase 4 / minimal upstream-refresh tick (26th consecutive steady-state tick).

Inherited closing state (after b0290..b0314):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0314).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0314)
...
PROBE RESULTS (see _work/batch_0315_probe.json for full data):
...
SANDBOX NOTE (carried from b0299..b0314):
...
Phase 4 disposition unchanged from b0293..b0314: cannot meaningfully

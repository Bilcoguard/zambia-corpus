#!/usr/bin/env python3
"""Batch 0518 — judgment-ingestion-worker dedicated tick.

Wraps b0506 fetcher; reads targets from _work/b0518/targets.json by default.
Continues ZMSC 2024 most-recent-first sweep into nums 10..3
(per b0517 next-tick recommendation).
"""
import json
import pathlib
import sys

#!/usr/bin/env python3
"""
Batch 0138 — Phase 4 bulk ingestion.

Continuation of the alphabetical-listing-first strategy from batches 0134–
0137. Targets drawn from the H/I block of _work/batch_0135_discovery.json
(ZambiaLII /legislation/ alphabetical ordering), picking up after
"Gwembe District Special Fund (Dissolution) Act, 1968":
  1. 1970/41 — Higher Authority for Power (Special Provisions) Act, 1970
  2. 1971/32 — Home Guard Act, 1971
  3. 1967/5  — Honours and Decorations (Prevention of Abuses), 1967
  4. 1987/27 — Hotels Act, 1987
  5. 1996/39 — Human Rights Commission Act, 1996
  6. 2010/18 — Immigration and Deportation Act, 2010
  7. 1967/32 — Income Tax Act, 1967
  8. 1993/27 — Industrial and Labour Relations Act, 1993
...
TARGETS = [
    (1970, 41, "higher-authority-for-power-special-provisions-act-1970"),
    (1971, 32, "home-guard-act-1971"),
    (1967, 5,  "honours-and-decorations-prevention-of-abuses-act-1967"),
    (1987, 27, "hotels-act-1987"),
    (1996, 39, "human-rights-commission-act-1996"),
    (2010, 18, "immigration-and-deportation-act-2010"),
    (1967, 32, "income-tax-act-1967"),
    (1993, 27, "industrial-and-labour-relations-act-1993"),
]
...
def write_batch_report(records, gaps, total_sections, fetches, integrity_passed):
    ...
    lines = [
        ...
        "batches 0134–0137. H/I block targets picked up after \"Gwembe "
        "District Special Fund (Dissolution) Act, 1968\" in the ZambiaLII "
        "/legislation/ alphabetical ordering — Higher Authority for Power "
        "(Special Provisions) 1970/41, Home Guard 1971/32, Honours and "
        "Decorations (Prevention of Abuses) 1967/5, Hotels 1987/27, "
        "Human Rights Commission 1996/39, Immigration and Deportation "
        "2010/18, Income Tax 1967/32, Industrial and Labour Relations "
        "1993/27. Fetched via AKN URL pattern with PDF fallback when HTML "
        "returned fewer than 2 parsed sections.",
        "",
        "## Committed records",
        "",
    ...
    lines.extend([
        "## Notes",
        "",
        "- Next tick: continue alphabetical /legislation/?page= discovery "
        "through the I–L block — Income Tax (Special Provisions) 1982/3 "
        "and 1988/16, Industrial Hemp 2021/34, Industrial Relations 1990/36 "
        "(per _work/batch_0135_discovery.json), then Intestate Succession, "
        "Judicature Administration, Juries, Juveniles, Labour, Lands, "
        "Legal Practitioners if present.",

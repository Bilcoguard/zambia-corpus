#!/usr/bin/env python3
"""Batch 0266 - Phase 4 bulk ingest. acts_in_force alphabet T residuals + U/V/W/Z probe sweep.

Discovery this tick: re-verified robots.txt (sha256 prefix fce67b697ee4ef44 unchanged),
then probed /legislation?alphabet=U|V|W|Y|Z&nature=act. Listings cached to
raw/zambialii/_alphabets/legislation-alphabet-{U,V,W,Y,Z}-20260426T1234*.html.
Filter: (yr, num) cross-checked against records/acts/**/*.json.
  T residuals carried from batch 0265: 3 (all confirmed not on disk).
  U new candidates: 2 (1987/20 University of Zambia + 1992/26 University Act).
  V new: 1 (1952/5 Victoria Memorial Institute (Repeal) Act).
  W new: 1 (1967/28 War Graves and Memorials Act).
  Y new: 0 (empty listing).
  Z new: 17 (large; one picked for chronological-coverage; 16 carry as residuals).

Picks total = 3 T-residuals + 2 U + 1 V + 1 W + 1 Z = 8 (MAX_BATCH_SIZE).

Reuses parser from batch_0264/0265 (PARSER_VERSION 0.6.0-act-zambialii-2026-04-26).
Continues acts_in_force alphabetic walk from batches 0253-0265.
"""
...
PICKS = [
    {"yr":"1952","num":"5","title":"Victoria Memorial Institute (Repeal) Act, 1952",
     "slug":"victoria-memorial-institute-repeal-act-1952","sub_phase":"acts_in_force","alpha":"V"},
    {"yr":"1950","num":"45","title":"Zambia Police Reserve Act, 1950",
     "slug":"zambia-police-reserve-act-1950","sub_phase":"acts_in_force","alpha":"Z"},
    {"yr":"1967","num":"28","title":"War Graves and Memorials Act, 1967",
     "slug":"war-graves-and-memorials-act-1967","sub_phase":"acts_in_force","alpha":"W"},
    {"yr":"1972","num":"26","title":"Termination of Pregnancy Act, 1972",
     "slug":"termination-of-pregnancy-act-1972","sub_phase":"acts_in_force","alpha":"T"},
    {"yr":"1972","num":"37","title":"Technical Education and Vocational Training Act, 1972",
     "slug":"technical-education-and-vocational-training-act-1972","sub_phase":"acts_in_force","alpha":"T"},
    {"yr":"1973","num":"49","title":"Trades Charges Act, 1973",
     "slug":"trades-charges-act-1973","sub_phase":"acts_in_force","alpha":"T"},
    {"yr":"1987","num":"20","title":"University of Zambia Act, 1987",
     "slug":"university-of-zambia-act-1987","sub_phase":"acts_in_force","alpha":"U"},
    {"yr":"1992","num":"26","title":"University Act, 1992",
     "slug":"university-act-1992","sub_phase":"acts_in_force","alpha":"U"},
]

#!/usr/bin/env python3
"""Batch 0346 parser-only step.

Parses the 8 ZMCC 2025 raw HTML+PDF pairs persisted by
batch_0346_fetch.py under the tightened parser_version 0.3.0 policy
locked in at b0344 (frozen from b0345):
...
TARGETS = [
    ...
    ("zmcc", 2025, 13, "2025-07-25"),
    ("zmcc", 2025, 12, "2025-06-27"),
    ("zmcc", 2025, 11, "2025-06-19"),
]

# ----------------------------------------------------------------------
# Outcome inference (frozen from b0344 — parser_version 0.3.0)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Judges parsing (frozen from b0344)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Judges registry update (frozen from b0344)
# ----------------------------------------------------------------------

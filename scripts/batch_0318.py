...
Inherited closing state (after b0290..b0317):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0317).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0317)
...
PROBE RESULTS (see _work/batch_0318_probe.json for full data):
  ...
  parliament page 0:      20 act links (2025/21..29 + 2026/1..11)
                          ALL 20 in corpus.
                          page sha256: 6b2922449d3af0886983bf63f3b42244617f280c0c4569d2d5320afee57f6c69
                          (differs from b0317 — session/CSRF token churn;
...
SANDBOX NOTE (carried from b0299..b0317):
...
Phase 4 disposition unchanged from b0293..b0317: cannot meaningfully

"""Batch 0332 — Phase 4 / minimal upstream-refresh tick (43rd consecutive steady-state tick).

Inherited closing state (after b0290..b0331):
  ...
  - OCR backlog: 21 (unchanged from b0293..b0331).
...
PARSER_VERSION: 0.5.0 (probe-only — same as b0290..b0331)
...
PROBE RESULTS (see _work/batch_0332_probe.json for full data):
  ...
  /legislation/recent:    15 act links (2026/1..11 + 2025/6..9).
                          ...
                          (UNCHANGED for the fourth consecutive tick —
                          feed surface and ranking are byte-for-byte
                          identical to b0329..b0331).
  parliament page 0:      20 act links (2026/1..11 + 2025/21..29).
                          ALL 20 in corpus.
                          page bytes: 38,208 (unchanged across all 43
                          steady-state ticks).
                          page sha256: 9cbe8f2c878e439c343951fab9fa732214103a077b90d7856de7e4cf02dde95c
...
SANDBOX NOTE (carried from b0299..b0331):
...
# The probe lives at _work/batch_0332_probe.py (gitignored scratch).
PICKS = []
"""
...
Phase 4 disposition unchanged from b0293..b0331: cannot meaningfully
